...
# ----------------------------
def create_flask_app_with_configs() -> MagicStudioApp:
    """
    create a raw flask app
    with configs loaded from .env file
    """
    magic_studio_app = MagicStudioApp(__name__)
    magic_studio_app.config.from_mapping(magic_studio_config.model_dump())
    magic_studio_app.config["RESTX_INCLUDE_ALL_MODELS"] = True

    # add before request hook
    @magic_studio_app.before_request
    def before_request():
    ...
    @magic_studio_app.after_request
    ...
    return magic_studio_app


def create_app() -> MagicStudioApp:
...
def initialize_extensions(app: MagicStudioApp):
...
def create_migrations_app() -> MagicStudioApp:
    app = create_flask_app_with_configs()
