...
def _refresh_oauth_if_expired(tenant_id: str, subscription: TriggerSubscription, now: int) -> None:
    threshold_seconds: int = int(magic_studio_config.TRIGGER_PROVIDER_CREDENTIAL_THRESHOLD_SECONDS)
    if (
...
def _refresh_subscription_if_expired(
    ...
    threshold_seconds: int = int(magic_studio_config.TRIGGER_PROVIDER_SUBSCRIPTION_THRESHOLD_SECONDS)
