...
class ExternalApi(Api):
    ...
    def __init__(self, app: Blueprint | Flask, *args, **kwargs):
        ...
        kwargs["add_specs"] = magic_studio_config.SWAGGER_UI_ENABLED
        kwargs["doc"] = magic_studio_config.SWAGGER_UI_PATH if magic_studio_config.SWAGGER_UI_ENABLED else False
