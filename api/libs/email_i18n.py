...
in Magic Studio. It follows Domain-Driven Design principles with proper type hints and
    ...
    def _render_email_content(
        ...
        full_context = {
            **template_context,
            ...
            "application_title": branding.application_title if branding.enabled else "Magic Studio",
        }
...
def create_default_email_config() -> EmailI18nConfig:
    ...
    templates: dict[EmailType, dict[EmailLanguage, EmailTemplate]] = {
        ...
        EmailType.ACCOUNT_DELETION_VERIFICATION: {
            EmailLanguage.EN_US: EmailTemplate(
                subject="Magic Studio Account Deletion and Verification",
