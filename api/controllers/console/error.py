...
class AlreadySetupError(BaseHTTPException):
    ...
    description = (
        "Magic Studio has been successfully installed. Please refresh the page or return to the dashboard homepage."
    )
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "Magic Studio has not been initialized and installed yet. "
