...
def check_version_update(query: VersionQuery) -> VersionResponse:
    ...
    check_update_url = magic_studio_config.CHECK_UPDATE_URL

    result = VersionResponse(
        version=magic_studio_config.project.version,
        release_date="",
        release_notes="",
        can_auto_update=False,
        features=VersionFeatures(
            can_replace_logo=magic_studio_config.CAN_REPLACE_LOGO,
            model_load_balancing_enabled=magic_studio_config.MODEL_LB_ENABLED,
        ),
    )
