...
class AnnotationBatchImportApi(Resource):
    ...
    def post(self, app_id):
        ...
        max_size_bytes = magic_studio_config.ANNOTATION_IMPORT_FILE_SIZE_LIMIT * 1024 * 1024
        if file_size > max_size_bytes:
            abort(
                413,
                f"File size exceeds maximum limit of {magic_studio_config.ANNOTATION_IMPORT_FILE_SIZE_LIMIT}MB. "
