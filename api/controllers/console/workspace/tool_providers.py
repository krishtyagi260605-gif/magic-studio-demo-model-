...
class ToolPluginOAuthApi(Resource):
    ...
    def get(self, provider):
        ...
        redirect_uri = f"{magic_studio_config.CONSOLE_API_URL}/console/api/oauth/plugin/{provider}/tool/callback"
...
class ToolOAuthCallback(Resource):
    ...
    def get(self, provider):
        ...
        return redirect(f"{magic_studio_config.CONSOLE_WEB_URL}/oauth-callback")
