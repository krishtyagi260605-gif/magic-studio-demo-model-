    ...
    def get(self):
        ...
        try:
            return {
                ...
                "host": magic_studio_config.PLUGIN_REMOTE_INSTALL_HOST,
                "port": magic_studio_config.PLUGIN_REMOTE_INSTALL_PORT,
            }
...
class PluginIconApi(Resource):
    ...
    def get(self):
        ...
        icon_cache_max_age = magic_studio_config.TOOL_ICON_CACHE_MAX_AGE
...
class PluginUploadFromPkgApi(Resource):
    ...
    def post(self):
        ...
        content = _read_upload_content(file, magic_studio_config.PLUGIN_MAX_PACKAGE_SIZE)
        try:
...
class PluginUploadFromBundleApi(Resource):
    ...
    def post(self):
        ...
        content = _read_upload_content(file, magic_studio_config.PLUGIN_MAX_BUNDLE_SIZE)
        try:
