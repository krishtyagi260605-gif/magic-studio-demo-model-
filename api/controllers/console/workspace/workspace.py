...
class TenantListApi(Resource):
    ...
    def get(self):
        ...
        tenant_dicts = []
        is_enterprise_only = magic_studio_config.ENTERPRISE_ENABLED and not magic_studio_config.BILLING_ENABLED
        is_saas = magic_studio_config.EDITION == "CLOUD" and magic_studio_config.BILLING_ENABLED
