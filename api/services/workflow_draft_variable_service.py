...
class DraftVariableSaver:
    ...
    def _try_offload_large_variable(
        ...
        truncator = VariableTruncator(
            max_size_bytes=magic_studio_config.WORKFLOW_VARIABLE_TRUNCATION_MAX_SIZE,
            array_element_limit=magic_studio_config.WORKFLOW_VARIABLE_TRUNCATION_ARRAY_LENGTH,
            string_length_limit=magic_studio_config.WORKFLOW_VARIABLE_TRUNCATION_STRING_LENGTH,
        )
