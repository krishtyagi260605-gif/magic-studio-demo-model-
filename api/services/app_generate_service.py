...
class AppGenerateService:
    ...
    def _build_streaming_task_on_subscribe(start_task: Callable[[], None]) -> Callable[[], None]:
        ...
        channel_type = magic_studio_config.PUBSUB_REDIS_CHANNEL_TYPE
    ...
    def _get_max_active_requests(app: App) -> int:
        ...
        """
        app_limit = app.max_active_requests or magic_studio_config.APP_DEFAULT_ACTIVE_REQUESTS
        config_limit = magic_studio_config.APP_MAX_ACTIVE_REQUESTS
