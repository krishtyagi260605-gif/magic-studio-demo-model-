...
class DocumentService:
    DEFAULT_RULES: dict[str, Any] = {
        ...
        "limits": {
            "indexing_max_segmentation_tokens_length": magic_studio_config.INDEXING_MAX_SEGMENTATION_TOKENS_LENGTH,
        },
    }
        ...
        if features.billing.enabled:
            if not knowledge_config.original_document_id:
                ...
                if knowledge_config.data_source:
                    ...
                    batch_upload_limit = int(magic_studio_config.BATCH_UPLOAD_LIMIT)
