...
class WorkflowRunCleanupMetrics:
    ...
    def _init_instruments(self) -> None:
        ...
        try:
            ...
            meter = get_meter("workflow_run_cleanup", version=magic_studio_config.project.version)
...
class WorkflowRunCleanup:
    def __init__(
        ...
        self.free_plan_grace_period_days = magic_studio_config.SANDBOX_EXPIRED_RECORDS_CLEAN_GRACEFUL_PERIOD
    ...
    def run(self) -> None:
        ...
        max_batch_interval_ms = magic_studio_config.SANDBOX_EXPIRED_RECORDS_CLEAN_BATCH_MAX_INTERVAL
    ...
    def _filter_free_tenants(self, tenant_ids: Iterable[str]) -> set[str]:
        ...
        if not magic_studio_config.BILLING_ENABLED:
