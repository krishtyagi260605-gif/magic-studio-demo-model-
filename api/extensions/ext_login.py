...
def load_user_from_request(request_from_flask_login: Request) -> LoginUser | None:
    ...
    if magic_studio_config.SWAGGER_UI_ENABLED and request.path.endswith((magic_studio_config.SWAGGER_UI_PATH, "/swagger.json")):
        return None

    auth_token = extract_access_token(request)

    # Check for admin API key authentication first
    if magic_studio_config.ADMIN_API_KEY_ENABLE and auth_token:
        admin_api_key = magic_studio_config.ADMIN_API_KEY
