...
class SupportsFlaskInstrumentor(Protocol):
    def instrument_app(
        self, app: MagicStudioApp, response_hook: Callable[[Span, str, list], None] | None = None, **kwargs: object
    ) -> None: ...
...
def init_flask_instrumentor(app: MagicStudioApp) -> None:
    meter = get_meter("http_metrics", version=magic_studio_config.project.version)
...
def init_sqlalchemy_instrumentor(app: MagicStudioApp) -> None:
...
def init_instruments(app: MagicStudioApp) -> None:
