...
class TencentCosStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = magic_studio_config.TENCENT_COS_BUCKET_NAME
        if magic_studio_config.TENCENT_COS_CUSTOM_DOMAIN:
            config = CosConfig(
                Domain=magic_studio_config.TENCENT_COS_CUSTOM_DOMAIN,
                SecretId=magic_studio_config.TENCENT_COS_SECRET_ID,
                SecretKey=magic_studio_config.TENCENT_COS_SECRET_KEY,
                Scheme=magic_studio_config.TENCENT_COS_SCHEME,
            )
        else:
            config = CosConfig(
                Region=magic_studio_config.TENCENT_COS_REGION,
                SecretId=magic_studio_config.TENCENT_COS_SECRET_ID,
                SecretKey=magic_studio_config.TENCENT_COS_SECRET_KEY,
                Scheme=magic_studio_config.TENCENT_COS_SCHEME,
            )
