...
class GoogleCloudStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = magic_studio_config.GOOGLE_STORAGE_BUCKET_NAME
        service_account_json_str = magic_studio_config.GOOGLE_STORAGE_SERVICE_ACCOUNT_JSON_BASE64
