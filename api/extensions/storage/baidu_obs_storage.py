...
class BaiduObsStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = magic_studio_config.BAIDU_OBS_BUCKET_NAME
        client_config = BceClientConfiguration(
            credentials=BceCredentials(
                access_key_id=magic_studio_config.BAIDU_OBS_ACCESS_KEY,
                secret_access_key=magic_studio_config.BAIDU_OBS_SECRET_KEY,
            ),
            endpoint=magic_studio_config.BAIDU_OBS_ENDPOINT,
        )
