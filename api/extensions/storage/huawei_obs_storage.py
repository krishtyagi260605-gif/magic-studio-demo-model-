...
class HuaweiObsStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = magic_studio_config.HUAWEI_OBS_BUCKET_NAME
        self.client = ObsClient(
            access_key_id=magic_studio_config.HUAWEI_OBS_ACCESS_KEY,
            secret_access_key=magic_studio_config.HUAWEI_OBS_SECRET_KEY,
            server=magic_studio_config.HUAWEI_OBS_SERVER,
            path_style=magic_studio_config.HUAWEI_OBS_PATH_STYLE,
        )
