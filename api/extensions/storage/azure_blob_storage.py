...
class AzureBlobStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = magic_studio_config.AZURE_BLOB_CONTAINER_NAME
        self.account_url = magic_studio_config.AZURE_BLOB_ACCOUNT_URL
        self.account_name = magic_studio_config.AZURE_BLOB_ACCOUNT_NAME
        self.account_key = magic_studio_config.AZURE_BLOB_ACCOUNT_KEY
