"""
Logstore extension for Magic Studio.
...
def is_enabled() -> bool:
    ...
    repository_configs = [
        magic_studio_config.CORE_WORKFLOW_EXECUTION_REPOSITORY,
        magic_studio_config.CORE_WORKFLOW_NODE_EXECUTION_REPOSITORY,
        magic_studio_config.API_WORKFLOW_NODE_EXECUTION_REPOSITORY,
        magic_studio_config.API_WORKFLOW_RUN_REPOSITORY,
    ]
...
def init_app(app: MagicStudioApp):
    ...
    Args:
        app: The Magic Studio application instance
    """
    try:
