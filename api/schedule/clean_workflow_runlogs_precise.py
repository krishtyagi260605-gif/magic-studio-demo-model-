...
MAX_RETRIES = 3
BATCH_SIZE = magic_studio_config.WORKFLOW_LOG_CLEANUP_BATCH_SIZE


def _get_specific_workflow_ids() -> list[str]:
    workflow_ids_str = magic_studio_config.WORKFLOW_LOG_CLEANUP_SPECIFIC_WORKFLOW_IDS.strip()
...
def clean_workflow_runlogs_precise() -> None:
    ...
    retention_days = magic_studio_config.WORKFLOW_LOG_RETENTION_DAYS
