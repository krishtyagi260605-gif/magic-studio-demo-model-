...
def reset_login_disabled(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(login_module.magic_studio_config, "LOGIN_DISABLED", False)
...
class TestLoginRequired:
    ...
    def test_bypass_paths_skip_authentication_and_csrf(
        ...
        monkeypatch.setattr(login_module.magic_studio_config, "LOGIN_DISABLED", login_disabled)
