...
class TestEmailTemplateRendering:
    ...
    def test_render_template_unsafe_mode(self):
        ...
        # Act
        with patch.object(magic_studio_config, "MAIL_TEMPLATING_MODE", TemplateMode.UNSAFE):
    ...
    def test_render_template_sandbox_mode(self):
        ...
        # Act
        with patch.object(magic_studio_config, "MAIL_TEMPLATING_MODE", TemplateMode.SANDBOX):
            with patch.object(magic_studio_config, "MAIL_TEMPLATING_TIMEOUT", 3):
                result = _render_template_with_strategy(body, substitutions)
    ...
    def test_render_template_disabled_mode(self):
        ...
        # Act
        with patch.object(magic_studio_config, "MAIL_TEMPLATING_MODE", TemplateMode.DISABLED):
            result = _render_template_with_strategy(body, substitutions)
    ...
    def test_render_template_sandbox_timeout(self):
        ...
        with patch.object(magic_studio_config, "MAIL_TEMPLATING_MODE", TemplateMode.SANDBOX):
            with patch.object(magic_studio_config, "MAIL_TEMPLATING_TIMEOUT", 1):
    ...
    def test_render_template_invalid_mode(self):
        ...
        # Act & Assert
        with patch.object(magic_studio_config, "MAIL_TEMPLATING_MODE", "invalid_mode"):
...
class TestMailTaskRetryLogic:
    ...
    @patch("tasks.mail_reset_password_task.get_email_i18n_service")
    @patch("tasks.mail_reset_password_task.mail")
    @patch("tasks.mail_reset_password_task.magic_studio_config")
...
class TestMailTaskInternationalization:
    ...
    @patch("tasks.mail_register_task.get_email_i18n_service")
    @patch("tasks.mail_register_task.mail")
    @patch("tasks.mail_register_task.magic_studio_config")
...
class TestMailExtension:
    ...
    @patch("extensions.ext_mail.magic_studio_config")
