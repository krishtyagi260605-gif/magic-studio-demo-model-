...
def test_request_with_ssrf_proxy(mocker):
    ...
    mocker.patch("configs.magic_studio_config.SSRF_PROXY_HTTP_URL", "http://proxy:8080")
    mocker.patch("configs.magic_studio_config.SSRF_PROXY_HTTPS_URL", "https://proxy:8081")
...
def test_request_with_only_one_proxy_config(mocker):
    # Mock magic_studio_config with only one proxy
    mocker.patch("configs.magic_studio_config.SSRF_PROXY_HTTP_URL", "http://proxy:8080")
    mocker.patch("configs.magic_studio_config.SSRF_PROXY_HTTPS_URL", None)
