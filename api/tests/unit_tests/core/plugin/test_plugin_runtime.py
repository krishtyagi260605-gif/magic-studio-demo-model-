...
class TestPluginRuntimeExecution:
    ...
    def mock_config(self):
        ...
        with (
            patch("core.plugin.impl.base.magic_studio_config.PLUGIN_DAEMON_URL", "http://127.0.0.1:5002"),
            patch("core.plugin.impl.base.magic_studio_config.PLUGIN_DAEMON_KEY", "test-api-key"),
        ):
            yield
...
class TestPluginRuntimeSandboxIsolation:
    ...
    def mock_config(self):
        ...
        with (
            patch("core.plugin.impl.base.magic_studio_config.PLUGIN_DAEMON_URL", "http://127.0.0.1:5002"),
            patch("core.plugin.impl.base.magic_studio_config.PLUGIN_DAEMON_KEY", "secure-api-key"),
        ):
            yield
...
class TestPluginRuntimeResourceLimits:
    ...
    def mock_config(self):
        ...
        with (
            patch("core.plugin.impl.base.magic_studio_config.PLUGIN_DAEMON_URL", "http://127.0.0.1:5002"),
            patch("core.plugin.impl.base.magic_studio_config.PLUGIN_DAEMON_KEY", "test-key"),
...
class TestPluginRuntimeSecurityAndValidation:
    ...
    def mock_config(self):
        ...
        with (
            patch("core.plugin.impl.base.magic_studio_config.PLUGIN_DAEMON_URL", "http://127.0.0.1:5002"),
            patch("core.plugin.impl.base.magic_studio_config.PLUGIN_DAEMON_KEY", "secure-key-123"),
        ):
            yield
