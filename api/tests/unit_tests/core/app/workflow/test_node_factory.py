...
class TestDifyNodeFactory:
    ...
    def _factory(self, monkeypatch):
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.CODE_MAX_STRING_LENGTH", 10)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.CODE_MAX_NUMBER", 10)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.CODE_MIN_NUMBER", -10)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.CODE_MAX_PRECISION", 4)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.CODE_MAX_DEPTH", 2)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.CODE_MAX_NUMBER_ARRAY_LENGTH", 2)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.CODE_MAX_STRING_ARRAY_LENGTH", 2)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.CODE_MAX_OBJECT_ARRAY_LENGTH", 2)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.TEMPLATE_TRANSFORM_MAX_LENGTH", 100)
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.UNSTRUCTURED_API_URL", "http://u")
        monkeypatch.setattr("core.workflow.node_factory.magic_studio_config.UNSTRUCTURED_API_KEY", "key")
