...
class TestNotionExtractorInitAndPublicMethods:
    ...
    def test_init_falls_back_to_env_token_when_credential_lookup_fails(self, monkeypatch):
        ...
        monkeypatch.setattr(notion_extractor.magic_studio_config, "NOTION_INTEGRATION_TOKEN", "env-token", raising=False)
    ...
    def test_init_raises_if_no_credential_and_no_env_token(self, monkeypatch):
        ...
        monkeypatch.setattr(notion_extractor.magic_studio_config, "NOTION_INTEGRATION_TOKEN", None, raising=False)
