...
def mock_dependencies(monkeypatch):
    ...
    # Mock config
    monkeypatch.setattr(pe.magic_studio_config, "FILES_URL", "http://files.local")
    monkeypatch.setattr(pe.magic_studio_config, "INTERNAL_FILES_URL", None)
    monkeypatch.setattr(pe.magic_studio_config, "STORAGE_TYPE", "local")
