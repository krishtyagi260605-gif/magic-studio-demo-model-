...
class TestExtractProcessorFileRouting:
    ...
    def _set_unstructured_config(self, monkeypatch):
        monkeypatch.setattr(processor_module.magic_studio_config, "UNSTRUCTURED_API_URL", "https://unstructured")
        monkeypatch.setattr(processor_module.magic_studio_config, "UNSTRUCTURED_API_KEY", "key")
    ...
    def _run_extract_for_extension(self, monkeypatch, extension: str, etl_type: str, is_automatic: bool = False):
        ...
        monkeypatch.setattr(processor_module.magic_studio_config, "ETL_TYPE", etl_type)
