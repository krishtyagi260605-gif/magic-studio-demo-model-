...
def test_qdrant_factory_paths(qdrant_module, monkeypatch):
    ...
    monkeypatch.setattr(qdrant_module.magic_studio_config, "QDRANT_URL", "http://localhost:6333")
    monkeypatch.setattr(qdrant_module.magic_studio_config, "QDRANT_API_KEY", "api-key")
    monkeypatch.setattr(qdrant_module.magic_studio_config, "QDRANT_CLIENT_TIMEOUT", 20)
    monkeypatch.setattr(qdrant_module.magic_studio_config, "QDRANT_GRPC_PORT", 6334)
    monkeypatch.setattr(qdrant_module.magic_studio_config, "QDRANT_GRPC_ENABLED", False)
    monkeypatch.setattr(qdrant_module.magic_studio_config, "QDRANT_REPLICATION_FACTOR", 1)
