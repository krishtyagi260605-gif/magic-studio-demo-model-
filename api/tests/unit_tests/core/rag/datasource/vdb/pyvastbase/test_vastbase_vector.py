...
def test_vastbase_factory_uses_existing_or_generated_collection(vastbase_module, monkeypatch):
    ...
    monkeypatch.setattr(vastbase_module.magic_studio_config, "VASTBASE_HOST", "localhost")
    monkeypatch.setattr(vastbase_module.magic_studio_config, "VASTBASE_PORT", 5432)
    monkeypatch.setattr(vastbase_module.magic_studio_config, "VASTBASE_USER", "dify")
    monkeypatch.setattr(vastbase_module.magic_studio_config, "VASTBASE_PASSWORD", "secret")
    monkeypatch.setattr(vastbase_module.magic_studio_config, "VASTBASE_DATABASE", "dify")
    monkeypatch.setattr(vastbase_module.magic_studio_config, "VASTBASE_MIN_CONNECTION", 1)
    monkeypatch.setattr(vastbase_module.magic_studio_config, "VASTBASE_MAX_CONNECTION", 5)
