...
def test_factory_initializes_collection_name_and_index_struct(baidu_module, monkeypatch):
    ...
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_ENDPOINT", "https://endpoint")
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_CONNECTION_TIMEOUT_MS", 1000)
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_ACCOUNT", "account")
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_API_KEY", "key")
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_DATABASE", "database")
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_SHARD", 1)
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_REPLICAS", 1)
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_INVERTED_INDEX_ANALYZER", "DEFAULT_ANALYZER")
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_INVERTED_INDEX_PARSER_MODE", "COARSE_MODE")
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_AUTO_BUILD_ROW_COUNT_INCREMENT", 500)
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_AUTO_BUILD_ROW_COUNT_INCREMENT_RATIO", 0.05)
    monkeypatch.setattr(baidu_module.magic_studio_config, "BAIDU_VECTOR_DB_REBUILD_INDEX_TIMEOUT_IN_SECONDS", 300)
