...
def test_factory_uses_existing_or_generated_collection(pgvecto_module, monkeypatch):
    ...
    monkeypatch.setattr(module.magic_studio_config, "PGVECTO_RS_HOST", "localhost")
    monkeypatch.setattr(module.magic_studio_config, "PGVECTO_RS_PORT", 5432)
    monkeypatch.setattr(module.magic_studio_config, "PGVECTO_RS_USER", "postgres")
    monkeypatch.setattr(module.magic_studio_config, "PGVECTO_RS_PASSWORD", "secret")
    monkeypatch.setattr(module.magic_studio_config, "PGVECTO_RS_DATABASE", "postgres")
