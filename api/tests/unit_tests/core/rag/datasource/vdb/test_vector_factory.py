...
def test_init_vector_uses_whitelist_override(vector_factory_module, monkeypatch):
    ...
    monkeypatch.setattr(vector_factory_module.magic_studio_config, "VECTOR_STORE", vector_factory_module.VectorType.CHROMA)
    monkeypatch.setattr(vector_factory_module.magic_studio_config, "VECTOR_STORE_WHITELIST_ENABLE", True)
    monkeypatch.setattr(
        vector_factory_module.Vector,
        "get_vector_factory",
        staticmethod(lambda vector_type: calls.update(vector_type=vector_type) or _Factory),
...
def test_init_vector_raises_when_vector_store_missing(vector_factory_module, monkeypatch):
    monkeypatch.setattr(vector_factory_module.magic_studio_config, "VECTOR_STORE", None)
    monkeypatch.setattr(vector_factory_module.magic_studio_config, "VECTOR_STORE_WHITELIST_ENABLE", False)
