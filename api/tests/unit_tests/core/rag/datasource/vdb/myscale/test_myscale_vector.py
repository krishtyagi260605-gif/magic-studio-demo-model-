...
def test_factory_initializes_lower_case_collection_name(myscale_module, monkeypatch):
    ...
    monkeypatch.setattr(myscale_module.magic_studio_config, "MYSCALE_HOST", "localhost")
    monkeypatch.setattr(myscale_module.magic_studio_config, "MYSCALE_PORT", 8123)
    monkeypatch.setattr(myscale_module.magic_studio_config, "MYSCALE_USER", "default")
    monkeypatch.setattr(myscale_module.magic_studio_config, "MYSCALE_PASSWORD", "")
    monkeypatch.setattr(myscale_module.magic_studio_config, "MYSCALE_DATABASE", "dify")
    monkeypatch.setattr(myscale_module.magic_studio_config, "MYSCALE_FTS_PARAMS", "")
