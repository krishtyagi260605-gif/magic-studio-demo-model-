...
def test_factory_init_vector_uses_existing_index_struct_class_prefix(monkeypatch):
    ...
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_HOST", "host")
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_PORT", 3306)
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_USER", "user")
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_PASSWORD", "password")
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_DATABASE", "db")
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_MAX_CONNECTION", 5)
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_CHARSET", "utf8mb4")
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_DISTANCE_FUNCTION", "cosine")
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_HNSW_M", 6)
...
def test_factory_init_vector_generates_collection_name_when_index_struct_is_missing(monkeypatch):
    ...
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_MAX_CONNECTION", 5)
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_CHARSET", "utf8mb4")
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_DISTANCE_FUNCTION", "euclidean")
    monkeypatch.setattr(alibaba_module.magic_studio_config, "ALIBABACLOUD_MYSQL_HNSW_M", 12)
