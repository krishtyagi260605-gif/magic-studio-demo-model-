...
def test_relyt_factory_existing_and_generated_collection(relyt_module, monkeypatch):
    ...
    monkeypatch.setattr(relyt_module.magic_studio_config, "RELYT_HOST", "localhost")
    monkeypatch.setattr(relyt_module.magic_studio_config, "RELYT_PORT", 5432)
    monkeypatch.setattr(relyt_module.magic_studio_config, "RELYT_USER", "postgres")
    monkeypatch.setattr(relyt_module.magic_studio_config, "RELYT_PASSWORD", "secret")
    monkeypatch.setattr(relyt_module.magic_studio_config, "RELYT_DATABASE", "relyt")
