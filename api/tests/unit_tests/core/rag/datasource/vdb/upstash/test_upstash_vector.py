...
def test_upstash_factory_uses_existing_or_generated_collection(upstash_module, monkeypatch):
    ...
    monkeypatch.setattr(upstash_module.magic_studio_config, "UPSTASH_VECTOR_URL", "https://upstash.example")
    monkeypatch.setattr(upstash_module.magic_studio_config, "UPSTASH_VECTOR_TOKEN", "token-123")
