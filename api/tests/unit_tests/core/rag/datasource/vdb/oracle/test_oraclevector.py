...
def test_oracle_factory_init_vector_uses_existing_or_generated_collection(oracle_module, monkeypatch):
    ...
    monkeypatch.setattr(oracle_module.magic_studio_config, "ORACLE_USER", "system")
    monkeypatch.setattr(oracle_module.magic_studio_config, "ORACLE_PASSWORD", "oracle")
    monkeypatch.setattr(oracle_module.magic_studio_config, "ORACLE_DSN", "oracle:1521/freepdb1")
    monkeypatch.setattr(oracle_module.magic_studio_config, "ORACLE_CONFIG_DIR", None)
    monkeypatch.setattr(oracle_module.magic_studio_config, "ORACLE_WALLET_LOCATION", None)
    monkeypatch.setattr(oracle_module.magic_studio_config, "ORACLE_WALLET_PASSWORD", None)
    monkeypatch.setattr(oracle_module.magic_studio_config, "ORACLE_IS_AUTONOMOUS", False)
