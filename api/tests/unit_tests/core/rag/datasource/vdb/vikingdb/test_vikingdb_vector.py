...
def test_vikingdb_factory_validates_config_and_builds_vector(vikingdb_module, monkeypatch):
    ...
    with patch.object(vikingdb_module, "VikingDBVector", return_value="vector") as vector_cls:
        monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_ACCESS_KEY", "ak")
        monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_SECRET_KEY", "sk")
        monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_HOST", "host")
        monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_REGION", "region")
        monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_SCHEME", "https")
        monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_CONNECTION_TIMEOUT", 10)
        monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_SOCKET_TIMEOUT", 20)
...
def test_vikingdb_factory_raises_when_required_config_missing(vikingdb_module, monkeypatch, field, message):
    ...
    monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_REGION", "region")
    monkeypatch.setattr(vikingdb_module.magic_studio_config, "VIKINGDB_SCHEME", "https")
    monkeypatch.setattr(vikingdb_module.magic_studio_config, field, None)
