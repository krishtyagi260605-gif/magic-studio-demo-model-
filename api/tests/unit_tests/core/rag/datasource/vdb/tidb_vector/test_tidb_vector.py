...
def test_tidb_factory_uses_existing_or_generated_collection(tidb_module, monkeypatch):
    ...
    monkeypatch.setattr(tidb_module.magic_studio_config, "TIDB_VECTOR_HOST", "localhost")
    monkeypatch.setattr(tidb_module.magic_studio_config, "TIDB_VECTOR_PORT", 4000)
    monkeypatch.setattr(tidb_module.magic_studio_config, "TIDB_VECTOR_USER", "root")
    monkeypatch.setattr(tidb_module.magic_studio_config, "TIDB_VECTOR_PASSWORD", "secret")
    monkeypatch.setattr(tidb_module.magic_studio_config, "TIDB_VECTOR_DATABASE", "dify")
    monkeypatch.setattr(tidb_module.magic_studio_config, "APPLICATION_NAME", "dify-app")
