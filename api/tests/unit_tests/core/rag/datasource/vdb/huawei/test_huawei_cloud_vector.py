...
def test_huawei_factory_branches(huawei_module, monkeypatch):
    ...
    monkeypatch.setattr(huawei_module.magic_studio_config, "HUAWEI_CLOUD_HOSTS", "http://huawei-es:9200")
    monkeypatch.setattr(huawei_module.magic_studio_config, "HUAWEI_CLOUD_USER", "user")
    monkeypatch.setattr(huawei_module.magic_studio_config, "HUAWEI_CLOUD_PASSWORD", "pass")
