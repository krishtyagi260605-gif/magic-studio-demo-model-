...
def test_lindorm_factory_branches(lindorm_module, monkeypatch):
    ...
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_URL", "http://localhost:9200")
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_USERNAME", "user")
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_PASSWORD", "pass")
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_QUERY_TIMEOUT", 3.0)
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_INDEX_TYPE", "hnsw")
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_DISTANCE_TYPE", "l2")
    ...
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_USING_UGC", None)
    ...
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_USING_UGC", False)
    ...
    monkeypatch.setattr(lindorm_module.magic_studio_config, "LINDORM_USING_UGC", True)
    with patch.object(lindorm_module, "LindormVectorStore", return_value="vector") as store_cls:
