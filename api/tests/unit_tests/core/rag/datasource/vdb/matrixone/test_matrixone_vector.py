...
def test_matrixone_factory_uses_existing_or_generated_collection(matrixone_module, monkeypatch):
    ...
    monkeypatch.setattr(matrixone_module.magic_studio_config, "MATRIXONE_HOST", "127.0.0.1")
    monkeypatch.setattr(matrixone_module.magic_studio_config, "MATRIXONE_PORT", 6001)
    monkeypatch.setattr(matrixone_module.magic_studio_config, "MATRIXONE_USER", "dump")
    monkeypatch.setattr(matrixone_module.magic_studio_config, "MATRIXONE_PASSWORD", "111")
    monkeypatch.setattr(matrixone_module.magic_studio_config, "MATRIXONE_DATABASE", "dify")
    monkeypatch.setattr(matrixone_module.magic_studio_config, "MATRIXONE_METRIC", "l2")
