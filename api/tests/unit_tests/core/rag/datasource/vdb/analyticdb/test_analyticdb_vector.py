...
def test_factory_builds_openapi_config_when_host_is_missing(monkeypatch):
    ...
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_HOST", None)
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_KEY_ID", "ak")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_KEY_SECRET", "sk")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_REGION_ID", "cn-hz")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_INSTANCE_ID", "instance")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_ACCOUNT", "account")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_PASSWORD", "password")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_NAMESPACE", "dify")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_NAMESPACE_PASSWORD", "ns-password")
...
def test_factory_builds_sql_config_when_host_is_present(monkeypatch):
    ...
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_HOST", "127.0.0.1")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_PORT", 5432)
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_ACCOUNT", "account")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_PASSWORD", "password")
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_MIN_CONNECTION", 1)
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_MAX_CONNECTION", 3)
    monkeypatch.setattr(analyticdb_module.magic_studio_config, "ANALYTICDB_NAMESPACE", "dify")
