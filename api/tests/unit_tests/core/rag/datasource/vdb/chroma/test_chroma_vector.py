...
def test_factory_init_vector_uses_existing_or_generated_collection(chroma_module, monkeypatch):
    ...
    monkeypatch.setattr(chroma_module.magic_studio_config, "CHROMA_HOST", "localhost")
    monkeypatch.setattr(chroma_module.magic_studio_config, "CHROMA_PORT", 8000)
    monkeypatch.setattr(chroma_module.magic_studio_config, "CHROMA_TENANT", None)
    monkeypatch.setattr(chroma_module.magic_studio_config, "CHROMA_DATABASE", None)
    monkeypatch.setattr(chroma_module.magic_studio_config, "CHROMA_AUTH_PROVIDER", None)
    monkeypatch.setattr(chroma_module.magic_studio_config, "CHROMA_AUTH_CREDENTIALS", None)
