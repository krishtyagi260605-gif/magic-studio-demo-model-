...
def test_create_collection_happy_path_with_hybrid_and_index(oceanbase_module, monkeypatch):
    ...
    monkeypatch.setattr(oceanbase_module.redis_client, "get", MagicMock(return_value=None))
    monkeypatch.setattr(oceanbase_module.redis_client, "set", MagicMock())
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_FULLTEXT_PARSER", "ik")
...
def test_create_collection_error_paths(oceanbase_module, monkeypatch):
    ...
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_FULLTEXT_PARSER", "not-valid")
...
def test_oceanbase_factory_uses_existing_or_generated_collection(oceanbase_module, monkeypatch):
    ...
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_HOST", "127.0.0.1")
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_PORT", 2881)
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_USER", "root")
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_PASSWORD", "password")
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_DATABASE", "test")
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_ENABLE_HYBRID_SEARCH", True)
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_BATCH_SIZE", 10)
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_METRIC_TYPE", "cosine")
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_HNSW_M", 16)
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_HNSW_EF_CONSTRUCTION", 64)
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_HNSW_EF_SEARCH", -1)
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_POOL_SIZE", 5)
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_VECTOR_MAX_OVERFLOW", 10)
    monkeypatch.setattr(oceanbase_module.magic_studio_config, "OCEANBASE_HNSW_REFRESH_THRESHOLD", 1000)
