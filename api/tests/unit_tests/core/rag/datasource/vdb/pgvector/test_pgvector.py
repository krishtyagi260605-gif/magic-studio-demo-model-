...
def test_pgvector_factory_initializes_expected_collection_name(monkeypatch):
    ...
    monkeypatch.setattr(pgvector_module.magic_studio_config, "PGVECTOR_HOST", "localhost")
    monkeypatch.setattr(pgvector_module.magic_studio_config, "PGVECTOR_PORT", 5432)
    monkeypatch.setattr(pgvector_module.magic_studio_config, "PGVECTOR_USER", "postgres")
    monkeypatch.setattr(pgvector_module.magic_studio_config, "PGVECTOR_PASSWORD", "secret")
    monkeypatch.setattr(pgvector_module.magic_studio_config, "PGVECTOR_DATABASE", "postgres")
    monkeypatch.setattr(pgvector_module.magic_studio_config, "PGVECTOR_MIN_CONNECTION", 1)
    monkeypatch.setattr(pgvector_module.magic_studio_config, "PGVECTOR_MAX_CONNECTION", 5)
    monkeypatch.setattr(pgvector_module.magic_studio_config, "PGVECTOR_PG_BIGM", False)
