...
def test_tencent_factory_existing_and_generated_collection(tencent_module, monkeypatch):
    ...
    monkeypatch.setattr(tencent_module.magic_studio_config, "TENCENT_VECTOR_DB_URL", "http://vdb.local")
    monkeypatch.setattr(tencent_module.magic_studio_config, "TENCENT_VECTOR_DB_API_KEY", "api-key")
    monkeypatch.setattr(tencent_module.magic_studio_config, "TENCENT_VECTOR_DB_TIMEOUT", 30)
    monkeypatch.setattr(tencent_module.magic_studio_config, "TENCENT_VECTOR_DB_USERNAME", "user")
    monkeypatch.setattr(tencent_module.magic_studio_config, "TENCENT_VECTOR_DB_DATABASE", "db")
    monkeypatch.setattr(tencent_module.magic_studio_config, "TENCENT_VECTOR_DB_SHARD", 1)
    monkeypatch.setattr(tencent_module.magic_studio_config, "TENCENT_VECTOR_DB_REPLICAS", 2)
    monkeypatch.setattr(tencent_module.magic_studio_config, "TENCENT_VECTOR_DB_ENABLE_HYBRID_SEARCH", True)
