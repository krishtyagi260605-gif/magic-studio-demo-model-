...
def test_opengauss_factory_uses_existing_or_generated_collection(opengauss_module, monkeypatch):
    ...
    monkeypatch.setattr(opengauss_module.magic_studio_config, "OPENGAUSS_HOST", "localhost")
    monkeypatch.setattr(opengauss_module.magic_studio_config, "OPENGAUSS_PORT", 6600)
    monkeypatch.setattr(opengauss_module.magic_studio_config, "OPENGAUSS_USER", "postgres")
    monkeypatch.setattr(opengauss_module.magic_studio_config, "OPENGAUSS_PASSWORD", "password")
    monkeypatch.setattr(opengauss_module.magic_studio_config, "OPENGAUSS_DATABASE", "dify")
    monkeypatch.setattr(opengauss_module.magic_studio_config, "OPENGAUSS_MIN_CONNECTION", 1)
    monkeypatch.setattr(opengauss_module.magic_studio_config, "OPENGAUSS_MAX_CONNECTION", 5)
    monkeypatch.setattr(opengauss_module.magic_studio_config, "OPENGAUSS_ENABLE_PQ", False)
