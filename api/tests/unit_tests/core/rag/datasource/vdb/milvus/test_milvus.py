...
def test_factory_initializes_milvus_vector(milvus_module, monkeypatch):
    ...
    monkeypatch.setattr(milvus_module.magic_studio_config, "MILVUS_URI", "http://localhost:19530")
    monkeypatch.setattr(milvus_module.magic_studio_config, "MILVUS_TOKEN", "")
    monkeypatch.setattr(milvus_module.magic_studio_config, "MILVUS_USER", "root")
    monkeypatch.setattr(milvus_module.magic_studio_config, "MILVUS_PASSWORD", "Milvus")
    monkeypatch.setattr(milvus_module.magic_studio_config, "MILVUS_DATABASE", "default")
    monkeypatch.setattr(milvus_module.magic_studio_config, "MILVUS_ENABLE_HYBRID_SEARCH", True)
    monkeypatch.setattr(milvus_module.magic_studio_config, "MILVUS_ANALYZER_PARAMS", '{"tokenizer":"standard"}')
