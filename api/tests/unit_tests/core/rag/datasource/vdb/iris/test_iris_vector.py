...
def test_iris_vector_delete_create_collection_and_factory(iris_module, monkeypatch):
    ...
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_HOST", "localhost")
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_SUPER_SERVER_PORT", 1972)
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_USER", "user")
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_PASSWORD", "pass")
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_DATABASE", "db")
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_SCHEMA", "schema")
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_CONNECTION_URL", "url")
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_MIN_CONNECTION", 1)
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_MAX_CONNECTION", 2)
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_TEXT_INDEX", True)
    monkeypatch.setattr(iris_module.magic_studio_config, "IRIS_TEXT_INDEX_LANGUAGE", "en")
