...
def test_opensearch_factory_initializes_expected_collection_name(opensearch_module, monkeypatch):
    ...
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_HOST", "localhost")
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_PORT", 9200)
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_SECURE", True)
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_VERIFY_CERTS", True)
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_AUTH_METHOD", "basic")
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_USER", "admin")
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_PASSWORD", "secret")
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_AWS_REGION", None)
    monkeypatch.setattr(opensearch_module.magic_studio_config, "OPENSEARCH_AWS_SERVICE", None)
