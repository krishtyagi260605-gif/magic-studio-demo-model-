...
def test_factory_initializes_clickzetta_vector(clickzetta_module, monkeypatch):
    ...
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_USERNAME", "username")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_PASSWORD", "password")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_INSTANCE", "instance")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_SERVICE", "service")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_WORKSPACE", "workspace")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_VCLUSTER", "cluster")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_SCHEMA", "dify")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_BATCH_SIZE", 10)
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_ENABLE_INVERTED_INDEX", True)
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_ANALYZER_TYPE", "chinese")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_ANALYZER_MODE", "smart")
    monkeypatch.setattr(clickzetta_module.magic_studio_config, "CLICKZETTA_VECTOR_DISTANCE_FUNCTION", "cosine_distance")
