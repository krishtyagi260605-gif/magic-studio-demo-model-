...
def test_hologres_factory_uses_existing_or_generated_collection(hologres_module, monkeypatch):
    ...
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_HOST", "127.0.0.1")
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_PORT", 80)
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_DATABASE", "dify")
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_ACCESS_KEY_ID", "ak")
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_ACCESS_KEY_SECRET", "sk")
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_SCHEMA", "public")
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_TOKENIZER", "jieba")
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_DISTANCE_METHOD", "Cosine")
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_BASE_QUANTIZATION_TYPE", "rabitq")
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_MAX_DEGREE", 64)
    monkeypatch.setattr(hologres_module.magic_studio_config, "HOLOGRES_EF_CONSTRUCTION", 400)
