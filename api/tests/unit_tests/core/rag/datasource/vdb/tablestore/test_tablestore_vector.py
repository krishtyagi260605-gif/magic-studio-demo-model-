...
def test_tablestore_factory_uses_existing_or_generated_collection(tablestore_module, monkeypatch):
    ...
    monkeypatch.setattr(tablestore_module.magic_studio_config, "TABLESTORE_ENDPOINT", "endpoint")
    monkeypatch.setattr(tablestore_module.magic_studio_config, "TABLESTORE_INSTANCE_NAME", "instance")
    monkeypatch.setattr(tablestore_module.magic_studio_config, "TABLESTORE_ACCESS_KEY_ID", "ak")
    monkeypatch.setattr(tablestore_module.magic_studio_config, "TABLESTORE_ACCESS_KEY_SECRET", "sk")
    monkeypatch.setattr(tablestore_module.magic_studio_config, "TABLESTORE_NORMALIZE_FULLTEXT_BM25_SCORE", True)
