...
def test_sign_tool_file_and_verify_roundtrip(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("core.tools.signature.magic_studio_config.SECRET_KEY", "unit-secret")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.FILES_URL", "https://files.example.com")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.INTERNAL_FILES_URL", "https://internal.example.com")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.FILES_ACCESS_TIMEOUT", 120)
...
def test_verify_tool_file_signature_rejects_invalid_sign(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("core.tools.signature.magic_studio_config.SECRET_KEY", "unit-secret")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.FILES_URL", "https://files.example.com")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.INTERNAL_FILES_URL", "")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.FILES_ACCESS_TIMEOUT", 10)
...
def test_get_signed_file_url_for_plugin_and_verify_roundtrip(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("core.tools.signature.magic_studio_config.FILES_URL", "https://files.example.com")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.INTERNAL_FILES_URL", "https://internal.example.com")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.FILES_ACCESS_TIMEOUT", 60)
...
def test_verify_plugin_file_signature_rejects_invalid_signatures(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("core.tools.signature.magic_studio_config.FILES_URL", "https://files.example.com")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.INTERNAL_FILES_URL", "")
    monkeypatch.setattr("core.tools.signature.magic_studio_config.FILES_ACCESS_TIMEOUT", 30)
