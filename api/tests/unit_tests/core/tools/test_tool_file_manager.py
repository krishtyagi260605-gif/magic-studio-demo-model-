...
def _setup_tool_file_signing(monkeypatch: pytest.MonkeyPatch) -> dict[str, str]:
    ...
    monkeypatch.setattr("core.tools.tool_file_manager.magic_studio_config.SECRET_KEY", "secret")
    monkeypatch.setattr("core.tools.tool_file_manager.magic_studio_config.FILES_URL", "https://files.example.com")
    monkeypatch.setattr("core.tools.tool_file_manager.magic_studio_config.INTERNAL_FILES_URL", "https://internal.example.com")
    monkeypatch.setattr("core.tools.tool_file_manager.magic_studio_config.FILES_ACCESS_TIMEOUT", 100)
...
def test_tool_file_manager_sign_verify_expired_timestamp(monkeypatch: pytest.MonkeyPatch) -> None:
    query = _setup_tool_file_signing(monkeypatch)
    monkeypatch.setattr("core.tools.tool_file_manager.magic_studio_config.FILES_ACCESS_TIMEOUT", 0)
