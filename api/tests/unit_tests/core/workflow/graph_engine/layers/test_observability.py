...
class TestObservabilityLayerInitialization:
    ...
    @patch("core.app.workflow.layers.observability.magic_studio_config.ENABLE_OTEL", True)
    ...
    @patch("core.app.workflow.layers.observability.magic_studio_config.ENABLE_OTEL", False)
