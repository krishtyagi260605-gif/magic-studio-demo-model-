...
# Application imports
from configs import magic_studio_config  # Configuration settings for file upload limits
...
class TestFileSizeLimiting:
    ...
    def test_is_file_size_within_limit_image(self):
        ...
        size_at_limit = magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
        ...
        def check_size(extension: str, file_size: int) -> bool:
            ...
            if extension in IMAGE_EXTENSIONS:
                file_size_limit = magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024  # Convert MB to bytes
            elif extension in VIDEO_EXTENSIONS:
                file_size_limit = magic_studio_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT * 1024 * 1024
            elif extension in AUDIO_EXTENSIONS:
                file_size_limit = magic_studio_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT * 1024 * 1024
            else:
                # Default limit for general files (documents, etc.)
                file_size_limit = magic_studio_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024
    ...
    def test_is_file_size_within_limit_video(self):
        ...
        size_at_limit = magic_studio_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT * 1024 * 1024

        # Act - Replicate the logic from FileService.is_file_size_within_limit
        def check_size(extension: str, file_size: int) -> bool:
            if extension in IMAGE_EXTENSIONS:
                file_size_limit = magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024
            elif extension in VIDEO_EXTENSIONS:
                file_size_limit = magic_studio_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT * 1024 * 1024
            elif extension in AUDIO_EXTENSIONS:
                file_size_limit = magic_studio_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT * 1024 * 1024
    ...
    def test_is_file_size_within_limit_audio(self):
        ...
        size_at_limit = magic_studio_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT * 1024 * 1024
    ...
    def test_is_file_size_within_limit_general(self):
        ...
        size_at_limit = magic_studio_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024
...
class TestBlacklistedExtensions:
    ...
    def test_blacklist_configuration(self):
        ...
        # Act
        blacklist = magic_studio_config.UPLOAD_FILE_EXTENSION_BLACKLIST
...
class TestConfigurationValidation:
    ...
    def test_upload_size_limits_are_positive(self):
        ...
        assert magic_studio_config.UPLOAD_FILE_SIZE_LIMIT > 0
        assert magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT > 0
        assert magic_studio_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT > 0
        assert magic_studio_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT > 0
    ...
    def test_upload_size_limits_reasonable_values(self):
        ...
        assert min_size <= magic_studio_config.UPLOAD_FILE_SIZE_LIMIT <= max_size
        assert min_size <= magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT <= max_size
        assert min_size <= magic_studio_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT <= max_size
        assert min_size <= magic_studio_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT <= max_size
    ...
    def test_video_size_limit_larger_than_image(self):
        ...
        assert magic_studio_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT >= magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT
