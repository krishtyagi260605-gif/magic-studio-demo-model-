...
def create_cleanup(
    ...
    **kwargs: Any,
    ...
    monkeypatch.setattr(
        cleanup_module.magic_studio_config,
...
def test_filter_free_tenants_billing_disabled(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(cleanup_module.magic_studio_config, "BILLING_ENABLED", False)
...
def test_filter_free_tenants_bulk_mixed(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(cleanup_module.magic_studio_config, "BILLING_ENABLED", True)
    monkeypatch.setattr(
