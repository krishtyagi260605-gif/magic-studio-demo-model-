...
def test_get_max_active_requests_uses_smallest_non_zero_limit(mocker) -> None:
    mocker.patch("services.rag_pipeline.pipeline_generate_service.magic_studio_config.APP_DEFAULT_ACTIVE_REQUESTS", 5)
    mocker.patch("services.rag_pipeline.pipeline_generate_service.magic_studio_config.APP_MAX_ACTIVE_REQUESTS", 3)
...
def test_get_max_active_requests_returns_zero_when_all_unlimited(mocker) -> None:
    mocker.patch("services.rag_pipeline.pipeline_generate_service.magic_studio_config.APP_DEFAULT_ACTIVE_REQUESTS", 0)
    mocker.patch("services.rag_pipeline.pipeline_generate_service.magic_studio_config.APP_MAX_ACTIVE_REQUESTS", 0)
