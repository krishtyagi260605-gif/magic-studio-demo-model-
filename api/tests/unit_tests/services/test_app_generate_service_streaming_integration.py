...
def _patch_get_channel_streams(monkeypatch):
    ...
    monkeypatch.setattr(ags.magic_studio_config, "PUBSUB_REDIS_CHANNEL_TYPE", "streams", raising=False)
...
def _patch_get_channel_pubsub(monkeypatch):
    ...
    monkeypatch.setattr(ags.magic_studio_config, "PUBSUB_REDIS_CHANNEL_TYPE", "pubsub", raising=False)
