...
def test_resolve_human_input_email_delivery_enabled_matrix(
    ...
    monkeypatch.setattr(feature_service_module.magic_studio_config, "ENTERPRISE_ENABLED", case.enterprise_enabled)
    monkeypatch.setattr(feature_service_module.magic_studio_config, "BILLING_ENABLED", case.billing_enabled)
