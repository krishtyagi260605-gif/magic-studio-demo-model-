...
def test_ensure_form_active_respects_global_timeout(monkeypatch, sample_form_record, mock_session_factory):
    ...
    monkeypatch.setattr(human_input_service_module.magic_studio_config, "HUMAN_INPUT_GLOBAL_TIMEOUT_SECONDS", 3600)
...
def test_is_globally_expired_zero_timeout(monkeypatch, sample_form_record, mock_session_factory):
    ...
    monkeypatch.setattr(human_input_service_module.magic_studio_config, "HUMAN_INPUT_GLOBAL_TIMEOUT_SECONDS", 0)
