...
class TestKnowledgeService:
    ...
    @patch("services.knowledge_service.magic_studio_config")
    def test_knowledge_retrieval_should_succeed_with_valid_results(
        self, mock_magic_studio_config: MagicMock, mock_boto_client: MagicMock
    ):
        """Test that knowledge_retrieval successfully parses results from Bedrock"""
        # Arrange
        mock_magic_studio_config.AWS_SECRET_ACCESS_KEY = "dummy_secret"
        mock_magic_studio_config.AWS_ACCESS_KEY_ID = "dummy_id"
