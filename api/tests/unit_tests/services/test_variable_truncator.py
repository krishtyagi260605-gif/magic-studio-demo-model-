...
def test_default_should_use_magic_studio_config_limits(monkeypatch: pytest.MonkeyPatch) -> None:
    # Arrange
    monkeypatch.setattr(truncator_module.magic_studio_config, "WORKFLOW_VARIABLE_TRUNCATION_MAX_SIZE", 111)
    monkeypatch.setattr(truncator_module.magic_studio_config, "WORKFLOW_VARIABLE_TRUNCATION_ARRAY_LENGTH", 7)
    monkeypatch.setattr(truncator_module.magic_studio_config, "WORKFLOW_VARIABLE_TRUNCATION_STRING_LENGTH", 33)
