...
class TestFileService:
    ...
    def test_upload_file_blocked_extension(self, file_service):
        with patch.object(magic_studio_config, "inner_UPLOAD_FILE_EXTENSION_BLACKLIST", "exe"):
    ...
    def test_upload_file_too_large(self, file_service):
        ...
        with patch.object(magic_studio_config, "UPLOAD_IMAGE_FILE_SIZE_LIMIT", 15):
    ...
    def test_is_file_size_within_limit(self):
        with (
            patch.object(magic_studio_config, "UPLOAD_IMAGE_FILE_SIZE_LIMIT", 10),
            patch.object(magic_studio_config, "UPLOAD_VIDEO_FILE_SIZE_LIMIT", 20),
            patch.object(magic_studio_config, "UPLOAD_AUDIO_FILE_SIZE_LIMIT", 30),
            patch.object(magic_studio_config, "UPLOAD_FILE_SIZE_LIMIT", 5),
        ):
            # Image
