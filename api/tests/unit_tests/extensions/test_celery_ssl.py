...
class TestCelerySSLConfiguration:
    ...
    def test_get_celery_ssl_options_when_ssl_disabled(self):
        ...
        from configs import MagicStudioConfig

        magic_studio_config = MagicStudioConfig(CELERY_BROKER_URL="redis://localhost:6379/0")

        with patch("extensions.ext_celery.magic_studio_config", magic_studio_config):
    ...
    def test_get_celery_ssl_options_when_broker_not_redis(self):
        ...
        with patch("extensions.ext_celery.magic_studio_config", mock_config):
            from extensions.ext_celery import _get_celery_ssl_options
