...
class TestTencentCosConfiguration:
    ...
    def test_init_with_custom_domain(self):
        ...
        # Mock magic_studio_config to return custom domain configuration
        mock_magic_studio_config = MagicMock()
        mock_magic_studio_config.TENCENT_COS_CUSTOM_DOMAIN = "cos.example.com"
        mock_magic_studio_config.TENCENT_COS_SECRET_ID = "test-secret-id"
        mock_magic_studio_config.TENCENT_COS_SECRET_KEY = "test-secret-key"
        mock_magic_studio_config.TENCENT_COS_SCHEME = "https"
        ...
        with (
            patch("extensions.storage.tencent_cos_storage.magic_studio_config", mock_magic_studio_config),
            patch(
    ...
    def test_init_with_region(self):
        ...
        # Mock magic_studio_config to return region configuration
        mock_magic_studio_config = MagicMock()
        mock_magic_studio_config.TENCENT_COS_CUSTOM_DOMAIN = None
        mock_magic_studio_config.TENCENT_COS_REGION = "ap-guangzhou"
        mock_magic_studio_config.TENCENT_COS_SECRET_ID = "test-secret-id"
        mock_magic_studio_config.TENCENT_COS_SECRET_KEY = "test-secret-key"
        mock_magic_studio_config.TENCENT_COS_SCHEME = "https"
