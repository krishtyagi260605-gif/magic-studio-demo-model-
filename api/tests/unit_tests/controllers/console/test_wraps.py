...
class TestEditionChecks:
    ...
    def test_only_edition_cloud_allows_cloud_edition(self):
        ...
        # Act
        with patch("controllers.console.wraps.magic_studio_config.EDITION", "CLOUD"):
            result = cloud_view()
    ...
    def test_only_edition_cloud_rejects_other_editions(self):
        ...
        with app.test_request_context():
            with patch("controllers.console.wraps.magic_studio_config.EDITION", "SELF_HOSTED"):
    ...
    def test_only_edition_enterprise_allows_when_enabled(self):
        ...
        # Act
        with patch("controllers.console.wraps.magic_studio_config.ENTERPRISE_ENABLED", True):
