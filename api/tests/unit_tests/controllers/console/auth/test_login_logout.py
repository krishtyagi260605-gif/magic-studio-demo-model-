...
class TestLoginApi:
    ...
    @patch("controllers.console.auth.login.magic_studio_config.BILLING_ENABLED", False)
    ...
    @patch("controllers.console.wraps.db")
    @patch("controllers.console.auth.login.magic_studio_config.BILLING_ENABLED", True)
