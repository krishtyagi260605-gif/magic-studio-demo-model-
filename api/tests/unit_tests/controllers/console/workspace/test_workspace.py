...
class TestTenantListApi:
    def test_get_success_saas_path(self, app):
        ...
        with (
            ...
            patch("controllers.console.workspace.workspace.magic_studio_config.ENTERPRISE_ENABLED", False),
            patch("controllers.console.workspace.workspace.magic_studio_config.BILLING_ENABLED", True),
            patch("controllers.console.workspace.workspace.magic_studio_config.EDITION", "CLOUD"),
            patch(
    ...
    def test_get_billing_disabled_community_path(self, app):
        ...
        with (
            ...
            patch("controllers.console.workspace.workspace.magic_studio_config.ENTERPRISE_ENABLED", False),
            patch("controllers.console.workspace.workspace.magic_studio_config.BILLING_ENABLED", False),
            patch("controllers.console.workspace.workspace.magic_studio_config.EDITION", "SELF_HOSTED"),
            patch(
                "controllers.console.workspace.workspace.FeatureService.get_features",
                return_value=features,
            ) as get_features_mock,
    ...
    def test_get_enterprise_only_skips_feature_service(self, app):
        ...
        with (
            ...
            patch("controllers.console.workspace.workspace.magic_studio_config.ENTERPRISE_ENABLED", True),
            patch("controllers.console.workspace.workspace.magic_studio_config.BILLING_ENABLED", False),
            patch("controllers.console.workspace.workspace.magic_studio_config.EDITION", "SELF_HOSTED"),
            patch("controllers.console.workspace.workspace.FeatureService.get_features") as get_features_mock,
        ):
