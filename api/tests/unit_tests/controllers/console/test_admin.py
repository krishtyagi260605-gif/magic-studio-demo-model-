...
def bypass_only_edition_cloud(mocker):
    ...
    """
    mocker.patch(
        "controllers.console.wraps.magic_studio_config.EDITION",
        new="CLOUD",
    )
...
def mock_admin_auth(mocker):
    ...
    """
    mocker.patch(
        "controllers.console.admin.magic_studio_config.ADMIN_API_KEY",
        "test-admin-key",
    )
    mocker.patch(
...
class TestAdminRequiredDecorator:
    ...
    def setup_method(self):
        ...
        self.magic_studio_config_patcher = patch("controllers.console.admin.magic_studio_config")
        self.mock_magic_studio_config = self.magic_studio_config_patcher.start()
        self.mock_magic_studio_config.ADMIN_API_KEY = "test-admin-key"
    ...
    def teardown_method(self):
        ...
        self.magic_studio_config_patcher.stop()
    ...
    def test_admin_required_no_api_key_configured(self):
        ...
        self.mock_magic_studio_config.ADMIN_API_KEY = None
