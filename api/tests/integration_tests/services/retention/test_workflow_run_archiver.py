...
class TestFilterPaidTenants:
    def test_all_tenants_paid_when_billing_disabled(self):
        ...
        with patch("services.retention.workflow_run.archive_paid_plan_workflow_run.magic_studio_config") as cfg:
    ...
    def test_only_paid_plans_returned(self):
        ...
        with (
            patch("services.retention.workflow_run.archive_paid_plan_workflow_run.magic_studio_config") as cfg,
