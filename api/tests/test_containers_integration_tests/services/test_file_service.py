...
class TestFileService:
    ...
    def test_upload_file_too_large(
        ...
        content = b"x" * (magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024 + 1)
        mimetype = "image/jpeg"
    ...
    def test_is_file_size_within_limit_image_success(
        ...
        """
        extension = "jpg"
        file_size = magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
    ...
    def test_is_file_size_within_limit_video_success(
        ...
        """
        extension = "mp4"
        file_size = magic_studio_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
    ...
    def test_is_file_size_within_limit_audio_success(
        ...
        """
        extension = "mp3"
        file_size = magic_studio_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
    ...
    def test_is_file_size_within_limit_document_success(
        ...
        """
        extension = "pdf"
        file_size = magic_studio_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
    ...
    def test_is_file_size_within_limit_image_exceeded(
        ...
        """
        extension = "jpg"
        file_size = magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024 + 1  # Exceeds limit
    ...
    def test_is_file_size_within_limit_unknown_extension(
        ...
        """
        extension = "xyz"
        file_size = magic_studio_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024  # Uses default limit
    ...
    def test_file_size_limits_edge_cases(
        ...
        for extension, limit_config in [
            ("jpg", magic_studio_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT),
            ("mp4", magic_studio_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT),
            ("mp3", magic_studio_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT),
            ("pdf", magic_studio_config.UPLOAD_FILE_SIZE_LIMIT),
        ]:
    ...
    def test_upload_file_blocked_extension(
        ...
        with patch.object(magic_studio_config, "inner_UPLOAD_FILE_EXTENSION_BLACKLIST", "exe,bat,sh"):
    ...
    def test_upload_file_blocked_extension_case_insensitive(
        ...
        # Mock blacklist configuration by patching the inner field
        with patch.object(magic_studio_config, "inner_UPLOAD_FILE_EXTENSION_BLACKLIST", "exe,bat"):
    ...
    def test_upload_file_empty_blacklist(
        ...
        with patch.object(magic_studio_config, "inner_UPLOAD_FILE_EXTENSION_BLACKLIST", ""):
    ...
    def test_upload_file_multiple_blocked_extensions(
        ...
        with patch.object(magic_studio_config, "inner_UPLOAD_FILE_EXTENSION_BLACKLIST", blacklist_str):
