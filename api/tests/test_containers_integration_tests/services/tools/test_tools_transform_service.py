...
class TestToolTransformService:
    ...
    def mock_external_service_dependencies(self):
        ...
        with patch("services.tools.tools_transform_service.magic_studio_config") as mock_magic_studio_config:
            with patch("services.plugin.plugin_service.magic_studio_config", new=mock_magic_studio_config):
                # Setup default mock returns
                mock_magic_studio_config.CONSOLE_API_URL = "https://console.example.com"
    ...
    def test_get_plugin_icon_url_with_empty_console_url(
        ...
        mock_external_service_dependencies["magic_studio_config"].CONSOLE_API_URL = None
        fake = Faker()
        tenant_id = fake.uuid4()
        filename = "test_icon.png"
