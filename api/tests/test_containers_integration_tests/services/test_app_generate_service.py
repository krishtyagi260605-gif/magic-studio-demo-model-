...
class TestAppGenerateService:
    ...
    def mock_external_service_dependencies(self):
        ...
        with (
            ...
            patch("services.app_generate_service.magic_studio_config", autospec=True) as mock_magic_studio_config,
            patch("configs.magic_studio_config", autospec=True) as mock_global_magic_studio_config,
        ):
            ...
            # Setup magic_studio_config mock returns
            mock_magic_studio_config.BILLING_ENABLED = False
            mock_magic_studio_config.APP_MAX_ACTIVE_REQUESTS = 100
            mock_magic_studio_config.APP_DEFAULT_ACTIVE_REQUESTS = 100
            mock_magic_studio_config.APP_DAILY_RATE_LIMIT = 1000

            mock_global_magic_studio_config.BILLING_ENABLED = False
            mock_global_magic_studio_config.APP_MAX_ACTIVE_REQUESTS = 100
            mock_global_magic_studio_config.APP_DAILY_RATE_LIMIT = 1000
            mock_global_magic_studio_config.HOSTED_POOL_CREDITS = 1000
            ...
            yield {
                ...
                "magic_studio_config": mock_magic_studio_config,
                "global_magic_studio_config": mock_global_magic_studio_config,
            }
    ...
    def test_generate_with_billing_enabled_sandbox_plan(
        ...
        mock_external_service_dependencies["magic_studio_config"].BILLING_ENABLED = True
        mock_external_service_dependencies["global_magic_studio_config"].BILLING_ENABLED = True
    ...
    def test_get_max_active_requests_with_zero_limits(
        ...
        assert result == 100  # magic_studio_config.APP_MAX_ACTIVE_REQUESTS
