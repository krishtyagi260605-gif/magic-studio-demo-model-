...
class NacosHttpClient:
    def __init__(self):
        self.username = os.getenv("MAGIC_STUDIO_ENV_NACOS_USERNAME")
        self.password = os.getenv("MAGIC_STUDIO_ENV_NACOS_PASSWORD")
        self.ak = os.getenv("MAGIC_STUDIO_ENV_NACOS_ACCESS_KEY")
        self.sk = os.getenv("MAGIC_STUDIO_ENV_NACOS_SECRET_KEY")
        self.server = os.getenv("MAGIC_STUDIO_ENV_NACOS_SERVER_ADDR", "localhost:8848")
    ...
    def _inject_auth_info(self, headers: dict[str, str], params: dict[str, str], module: str = "config") -> None:
        headers.update({"User-Agent": "Nacos-Http-Client-In-Magic-Studio:v0.0.1"})
