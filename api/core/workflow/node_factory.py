...
class DifyNodeFactory(NodeFactory):
    ...
    def __init__(
        ...
        self._code_limits = CodeNodeLimits(
            ...
            max_number=magic_studio_config.CODE_MAX_NUMBER,
            min_number=magic_studio_config.CODE_MIN_NUMBER,
            max_precision=magic_studio_config.CODE_MAX_PRECISION,
            max_depth=magic_studio_config.CODE_MAX_DEPTH,
            max_number_array_length=magic_studio_config.CODE_MAX_NUMBER_ARRAY_LENGTH,
            max_string_array_length=magic_studio_config.CODE_MAX_STRING_ARRAY_LENGTH,
            max_object_array_length=magic_studio_config.CODE_MAX_OBJECT_ARRAY_LENGTH,
        )
        ...
        self._document_extractor_unstructured_api_config = UnstructuredApiConfig(
            ...
            api_key=magic_studio_config.UNSTRUCTURED_API_KEY or "",
        )
        self._http_request_config = build_http_request_config(
            max_connect_timeout=magic_studio_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
            max_read_timeout=magic_studio_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
            max_write_timeout=magic_studio_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
            max_binary_size=magic_studio_config.HTTP_REQUEST_NODE_MAX_BINARY_SIZE,
            max_text_size=magic_studio_config.HTTP_REQUEST_NODE_MAX_TEXT_SIZE,
            ssl_verify=magic_studio_config.HTTP_REQUEST_NODE_SSL_VERIFY,
    ...
    def create_node(self, node_config: dict[str, Any] | NodeConfigDict) -> Node:
        ...
        node_init_kwargs_factories: Mapping[NodeType, Callable[[], dict[str, object]]] = {
            ...
            "builtin_node:a2a": lambda: {},
            "builtin_node:approval": lambda: {},
        }
