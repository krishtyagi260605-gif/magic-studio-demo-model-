...
class ProviderManager:
    ...
    def get_configurations(self, tenant_id: str) -> ProviderConfigurations:
        ...
        for provider_entity in provider_entities:
            ...
            if is_filtered(
                include_set=magic_studio_config.POSITION_PROVIDER_INCLUDES_SET,
                exclude_set=magic_studio_config.POSITION_PROVIDER_EXCLUDES_SET,
            ...
            elif magic_studio_config.EDITION == "CLOUD" and system_configuration.enabled:
