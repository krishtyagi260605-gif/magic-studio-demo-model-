    ...
    def extract(
        ...
        if extract_setting.datasource_type == DatasourceType.FILE:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                etl_type = magic_studio_config.ETL_TYPE
                extractor: BaseExtractor | None = None
                if etl_type == "Unstructured":
                    unstructured_api_url = magic_studio_config.UNSTRUCTURED_API_URL or ""
                    unstructured_api_key = magic_studio_config.UNSTRUCTURED_API_KEY or ""
