...
class ClickzettaVectorFactory(AbstractVectorFactory):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        config = ClickzettaConfig(
            username=magic_studio_config.CLICKZETTA_USERNAME or "",
            password=magic_studio_config.CLICKZETTA_PASSWORD or "",
            instance=magic_studio_config.CLICKZETTA_INSTANCE or "",
            service=magic_studio_config.CLICKZETTA_SERVICE or "api.clickzetta.com",
            workspace=magic_studio_config.CLICKZETTA_WORKSPACE or "quick_start",
            vcluster=magic_studio_config.CLICKZETTA_VCLUSTER or "default_ap",
            schema_name=magic_studio_config.CLICKZETTA_SCHEMA or "dify",
            batch_size=magic_studio_config.CLICKZETTA_BATCH_SIZE or 100,
            enable_inverted_index=magic_studio_config.CLICKZETTA_ENABLE_INVERTED_INDEX or True,
            analyzer_type=magic_studio_config.CLICKZETTA_ANALYZER_TYPE or "chinese",
            analyzer_mode=magic_studio_config.CLICKZETTA_ANALYZER_MODE or "smart",
            vector_distance_function=magic_studio_config.CLICKZETTA_VECTOR_DISTANCE_FUNCTION or "cosine_distance",
        )
