...
class OpenSearchVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenSearchVector:
        ...
        open_search_config = OpenSearchConfig(
            host=magic_studio_config.OPENSEARCH_HOST or "localhost",
            port=magic_studio_config.OPENSEARCH_PORT,
            secure=magic_studio_config.OPENSEARCH_SECURE,
            verify_certs=magic_studio_config.OPENSEARCH_VERIFY_CERTS,
            auth_method=magic_studio_config.OPENSEARCH_AUTH_METHOD,
            user=magic_studio_config.OPENSEARCH_USER,
            password=magic_studio_config.OPENSEARCH_PASSWORD,
            aws_region=magic_studio_config.OPENSEARCH_AWS_REGION,
            aws_service=magic_studio_config.OPENSEARCH_AWS_SERVICE,
        )
