...
class MilvusVectorFactory(AbstractVectorFactory):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            ...
            config=MilvusConfig(
                uri=magic_studio_config.MILVUS_URI or "",
                token=magic_studio_config.MILVUS_TOKEN or "",
                user=magic_studio_config.MILVUS_USER or "",
                password=magic_studio_config.MILVUS_PASSWORD or "",
                database=magic_studio_config.MILVUS_DATABASE or "",
                enable_hybrid_search=magic_studio_config.MILVUS_ENABLE_HYBRID_SEARCH or False,
                analyzer_params=magic_studio_config.MILVUS_ANALYZER_PARAMS or "",
            ),
        )
