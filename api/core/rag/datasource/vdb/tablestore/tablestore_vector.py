    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TableStoreVector:
        ...
        return TableStoreVector(
            ...
            config=TableStoreConfig(
                endpoint=magic_studio_config.TABLESTORE_ENDPOINT,
                instance_name=magic_studio_config.TABLESTORE_INSTANCE_NAME,
                access_key_id=magic_studio_config.TABLESTORE_ACCESS_KEY_ID,
                access_key_secret=magic_studio_config.TABLESTORE_ACCESS_KEY_SECRET,
                normalize_full_text_bm25_score=magic_studio_config.TABLESTORE_NORMALIZE_FULLTEXT_BM25_SCORE,
            ),
        )
