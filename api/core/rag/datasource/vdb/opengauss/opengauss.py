    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenGauss:
        ...
        return OpenGauss(
            ...
            config=OpenGaussConfig(
                host=magic_studio_config.OPENGAUSS_HOST or "localhost",
                port=magic_studio_config.OPENGAUSS_PORT,
                user=magic_studio_config.OPENGAUSS_USER or "postgres",
                password=magic_studio_config.OPENGAUSS_PASSWORD or "",
                database=magic_studio_config.OPENGAUSS_DATABASE or "dify",
                min_connection=magic_studio_config.OPENGAUSS_MIN_CONNECTION,
                max_connection=magic_studio_config.OPENGAUSS_MAX_CONNECTION,
                enable_pq=magic_studio_config.OPENGAUSS_ENABLE_PQ or False,
            ),
        )
