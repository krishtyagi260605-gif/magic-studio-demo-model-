    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> HologresVector:
        ...
        return HologresVector(
            ...
            config=HologresVectorConfig(
                host=magic_studio_config.HOLOGRES_HOST or "",
                port=magic_studio_config.HOLOGRES_PORT,
                database=magic_studio_config.HOLOGRES_DATABASE or "",
                access_key_id=magic_studio_config.HOLOGRES_ACCESS_KEY_ID or "",
                access_key_secret=magic_studio_config.HOLOGRES_ACCESS_KEY_SECRET or "",
                schema_name=magic_studio_config.HOLOGRES_SCHEMA,
                tokenizer=magic_studio_config.HOLOGRES_TOKENIZER,
                distance_method=magic_studio_config.HOLOGRES_DISTANCE_METHOD,
                base_quantization_type=magic_studio_config.HOLOGRES_BASE_QUANTIZATION_TYPE,
                max_degree=magic_studio_config.HOLOGRES_MAX_DEGREE,
                ef_construction=magic_studio_config.HOLOGRES_EF_CONSTRUCTION,
            ),
        )
