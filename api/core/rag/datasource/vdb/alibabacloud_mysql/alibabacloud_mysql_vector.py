    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> AlibabaCloudMySQLVector:
        ...
        return AlibabaCloudMySQLVector(
            ...
            config=AlibabaCloudMySQLVectorConfig(
                host=magic_studio_config.ALIBABACLOUD_MYSQL_HOST or "localhost",
                port=magic_studio_config.ALIBABACLOUD_MYSQL_PORT,
                user=magic_studio_config.ALIBABACLOUD_MYSQL_USER or "root",
                password=magic_studio_config.ALIBABACLOUD_MYSQL_PASSWORD or "",
                database=magic_studio_config.ALIBABACLOUD_MYSQL_DATABASE or "dify",
                max_connection=magic_studio_config.ALIBABACLOUD_MYSQL_MAX_CONNECTION,
                charset=magic_studio_config.ALIBABACLOUD_MYSQL_CHARSET or "utf8mb4",
                distance_function=self._validate_distance_function(
                    magic_studio_config.ALIBABACLOUD_MYSQL_DISTANCE_FUNCTION or "cosine"
                ),
                hnsw_m=magic_studio_config.ALIBABACLOUD_MYSQL_HNSW_M or 6,
            ),
        )
