    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> HuaweiCloudVector:
        ...
        return HuaweiCloudVector(
            ...
            config=HuaweiCloudVectorConfig(
                hosts=magic_studio_config.HUAWEI_CLOUD_HOSTS or "http://localhost:9200",
                username=magic_studio_config.HUAWEI_CLOUD_USER,
                password=magic_studio_config.HUAWEI_CLOUD_PASSWORD,
            ),
        )
