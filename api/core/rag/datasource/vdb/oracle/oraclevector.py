    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                user=magic_studio_config.ORACLE_USER or "system",
                password=magic_studio_config.ORACLE_PASSWORD or "oracle",
                dsn=magic_studio_config.ORACLE_DSN or "oracle:1521/freepdb1",
                config_dir=magic_studio_config.ORACLE_CONFIG_DIR,
                wallet_location=magic_studio_config.ORACLE_WALLET_LOCATION,
                wallet_password=magic_studio_config.ORACLE_WALLET_PASSWORD,
                is_autonomous=magic_studio_config.ORACLE_IS_AUTONOMOUS,
            ),
        )
