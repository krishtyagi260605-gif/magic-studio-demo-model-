                        ...
                        "properties": {
                            ...
                            Field.VECTOR: {
                                ...
                                "method": {
                                    ...
                                    if index_params
                                    else magic_studio_config.LINDORM_INDEX_TYPE,
                                    "space_type": index_params.get("space_type", "l2")
                                    if index_params
                                    else magic_studio_config.LINDORM_DISTANCE_TYPE,
                                    "engine": "lvector",
                                },
                            },
                        }
...
class LindormVectorStoreFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> LindormVectorStore:
        lindorm_config = LindormVectorStoreConfig(
            hosts=magic_studio_config.LINDORM_URL,
            username=magic_studio_config.LINDORM_USERNAME,
            password=magic_studio_config.LINDORM_PASSWORD,
            using_ugc=magic_studio_config.LINDORM_USING_UGC,
            request_timeout=magic_studio_config.LINDORM_QUERY_TIMEOUT,
        )
        using_ugc = magic_studio_config.LINDORM_USING_UGC
        ...
        if dataset.index_struct:
            ...
            index_struct_dict = {
                ...
                "index_type": magic_studio_config.LINDORM_INDEX_TYPE,
                "dimension": dimension,
                "distance_type": magic_studio_config.LINDORM_DISTANCE_TYPE,
                "using_ugc": using_ugc,
            }
