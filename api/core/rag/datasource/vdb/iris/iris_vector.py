    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> IrisVector:
        ...
        return IrisVector(
            ...
            config=IrisVectorConfig(
                IRIS_HOST=magic_studio_config.IRIS_HOST,
                IRIS_SUPER_SERVER_PORT=magic_studio_config.IRIS_SUPER_SERVER_PORT,
                IRIS_USER=magic_studio_config.IRIS_USER,
                IRIS_PASSWORD=magic_studio_config.IRIS_PASSWORD,
                IRIS_DATABASE=magic_studio_config.IRIS_DATABASE,
                IRIS_SCHEMA=magic_studio_config.IRIS_SCHEMA,
                IRIS_CONNECTION_URL=magic_studio_config.IRIS_CONNECTION_URL,
                IRIS_MIN_CONNECTION=magic_studio_config.IRIS_MIN_CONNECTION,
                IRIS_MAX_CONNECTION=magic_studio_config.IRIS_MAX_CONNECTION,
                IRIS_TEXT_INDEX=magic_studio_config.IRIS_TEXT_INDEX,
                IRIS_TEXT_INDEX_LANGUAGE=magic_studio_config.IRIS_TEXT_INDEX_LANGUAGE,
            ),
        )
