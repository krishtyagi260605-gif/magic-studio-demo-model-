...
class BaiduVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaiduVector:
        ...
        return BaiduVector(
            ...
            config=BaiduConfig(
                endpoint=magic_studio_config.BAIDU_VECTOR_DB_ENDPOINT or "",
                connection_timeout_in_mills=magic_studio_config.BAIDU_VECTOR_DB_CONNECTION_TIMEOUT_MS,
                account=magic_studio_config.BAIDU_VECTOR_DB_ACCOUNT or "",
                api_key=magic_studio_config.BAIDU_VECTOR_DB_API_KEY or "",
                database=magic_studio_config.BAIDU_VECTOR_DB_DATABASE or "",
                shard=magic_studio_config.BAIDU_VECTOR_DB_SHARD,
                replicas=magic_studio_config.BAIDU_VECTOR_DB_REPLICAS,
                inverted_index_analyzer=magic_studio_config.BAIDU_VECTOR_DB_INVERTED_INDEX_ANALYZER,
                inverted_index_parser_mode=magic_studio_config.BAIDU_VECTOR_DB_INVERTED_INDEX_PARSER_MODE,
                auto_build_row_count_increment=magic_studio_config.BAIDU_VECTOR_DB_AUTO_BUILD_ROW_COUNT_INCREMENT,
                auto_build_row_count_increment_ratio=magic_studio_config.BAIDU_VECTOR_DB_AUTO_BUILD_ROW_COUNT_INCREMENT_RATIO,
                rebuild_index_timeout_in_seconds=magic_studio_config.BAIDU_VECTOR_DB_REBUILD_INDEX_TIMEOUT_IN_SECONDS,
            ),
        )
