    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TencentVector:
        ...
        return TencentVector(
            ...
            config=TencentConfig(
                url=magic_studio_config.TENCENT_VECTOR_DB_URL or "",
                api_key=magic_studio_config.TENCENT_VECTOR_DB_API_KEY,
                timeout=magic_studio_config.TENCENT_VECTOR_DB_TIMEOUT,
                username=magic_studio_config.TENCENT_VECTOR_DB_USERNAME,
                database=magic_studio_config.TENCENT_VECTOR_DB_DATABASE,
                shard=magic_studio_config.TENCENT_VECTOR_DB_SHARD,
                replicas=magic_studio_config.TENCENT_VECTOR_DB_REPLICAS,
                enable_hybrid_search=magic_studio_config.TENCENT_VECTOR_DB_ENABLE_HYBRID_SEARCH or False,
            ),
        )
