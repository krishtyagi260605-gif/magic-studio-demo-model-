...
class ChromaVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        return ChromaVector(
            ...
            config=ChromaConfig(
                host=magic_studio_config.CHROMA_HOST or "",
                port=magic_studio_config.CHROMA_PORT,
                tenant=magic_studio_config.CHROMA_TENANT or chromadb.DEFAULT_TENANT,
                database=magic_studio_config.CHROMA_DATABASE or chromadb.DEFAULT_DATABASE,
                auth_provider=magic_studio_config.CHROMA_AUTH_PROVIDER,
                auth_credentials=magic_studio_config.CHROMA_AUTH_CREDENTIALS,
            ),
        )
