    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> VastbaseVector:
        ...
        return VastbaseVector(
            ...
            config=VastbaseVectorConfig(
                host=magic_studio_config.VASTBASE_HOST or "localhost",
                port=magic_studio_config.VASTBASE_PORT,
                user=magic_studio_config.VASTBASE_USER or "dify",
                password=magic_studio_config.VASTBASE_PASSWORD or "",
                database=magic_studio_config.VASTBASE_DATABASE or "dify",
                min_connection=magic_studio_config.VASTBASE_MIN_CONNECTION,
                max_connection=magic_studio_config.VASTBASE_MAX_CONNECTION,
            ),
        )
