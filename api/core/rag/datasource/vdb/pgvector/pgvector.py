    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVector:
        ...
        return PGVector(
            ...
            config=PGVectorConfig(
                host=magic_studio_config.PGVECTOR_HOST or "localhost",
                port=magic_studio_config.PGVECTOR_PORT,
                user=magic_studio_config.PGVECTOR_USER or "postgres",
                password=magic_studio_config.PGVECTOR_PASSWORD or "",
                database=magic_studio_config.PGVECTOR_DATABASE or "postgres",
                min_connection=magic_studio_config.PGVECTOR_MIN_CONNECTION,
                max_connection=magic_studio_config.PGVECTOR_MAX_CONNECTION,
                pg_bigm=magic_studio_config.PGVECTOR_PG_BIGM,
            ),
        )
