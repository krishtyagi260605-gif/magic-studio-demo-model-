    ...
    def _create_collection(self):
        ...
        with redis_client.lock(lock_name, timeout=20):
            ...
            if self._hybrid_search_enabled:
                ...
                parser_name = magic_studio_config.OCEANBASE_FULLTEXT_PARSER or "ik"
    ...
    def init_vector(
        ...
        return OceanBaseVector(
            ...
            OceanBaseVectorConfig(
                host=magic_studio_config.OCEANBASE_VECTOR_HOST or "",
                port=magic_studio_config.OCEANBASE_VECTOR_PORT or 0,
                user=magic_studio_config.OCEANBASE_VECTOR_USER or "",
                password=(magic_studio_config.OCEANBASE_VECTOR_PASSWORD or ""),
                database=magic_studio_config.OCEANBASE_VECTOR_DATABASE or "",
                enable_hybrid_search=magic_studio_config.OCEANBASE_ENABLE_HYBRID_SEARCH or False,
                batch_size=magic_studio_config.OCEANBASE_VECTOR_BATCH_SIZE,
                metric_type=magic_studio_config.OCEANBASE_VECTOR_METRIC_TYPE,
                hnsw_m=magic_studio_config.OCEANBASE_HNSW_M,
                hnsw_ef_construction=magic_studio_config.OCEANBASE_HNSW_EF_CONSTRUCTION,
                hnsw_ef_search=magic_studio_config.OCEANBASE_HNSW_EF_SEARCH,
                pool_size=magic_studio_config.OCEANBASE_VECTOR_POOL_SIZE,
                max_overflow=magic_studio_config.OCEANBASE_VECTOR_MAX_OVERFLOW,
                hnsw_refresh_threshold=magic_studio_config.OCEANBASE_HNSW_REFRESH_THRESHOLD,
            ),
        )
