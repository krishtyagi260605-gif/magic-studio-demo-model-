    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TidbOnQdrantVector:
                ...
                if tidb_auth_binding:
                    ...
                    if idle_tidb_auth_binding:
                        ...
                        new_cluster = TidbService.create_tidb_serverless_cluster(
                            magic_studio_config.TIDB_PROJECT_ID or "",
                            magic_studio_config.TIDB_API_URL or "",
                            magic_studio_config.TIDB_IAM_API_URL or "",
                            magic_studio_config.TIDB_PUBLIC_KEY or "",
                            magic_studio_config.TIDB_PRIVATE_KEY or "",
                            magic_studio_config.TIDB_REGION or "",
                        )
        ...
        return TidbOnQdrantVector(
            ...
            config=TidbOnQdrantConfig(
                endpoint=magic_studio_config.TIDB_ON_QDRANT_URL or "",
                api_key=TIDB_ON_QDRANT_API_KEY,
                root_path=str(config.root_path),
                timeout=magic_studio_config.TIDB_ON_QDRANT_CLIENT_TIMEOUT,
                grpc_port=magic_studio_config.TIDB_ON_QDRANT_GRPC_PORT,
                prefer_grpc=magic_studio_config.TIDB_ON_QDRANT_GRPC_ENABLED,
                replication_factor=magic_studio_config.QDRANT_REPLICATION_FACTOR,
            ),
        )
