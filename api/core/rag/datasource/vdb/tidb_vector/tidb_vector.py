    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TiDBVector:
        ...
        return TiDBVector(
            ...
            config=TiDBVectorConfig(
                host=magic_studio_config.TIDB_VECTOR_HOST or "",
                port=magic_studio_config.TIDB_VECTOR_PORT or 0,
                user=magic_studio_config.TIDB_VECTOR_USER or "",
                password=magic_studio_config.TIDB_VECTOR_PASSWORD or "",
                database=magic_studio_config.TIDB_VECTOR_DATABASE or "",
                program_name=magic_studio_config.APPLICATION_NAME,
            ),
        )
