    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MyScaleVector:
        ...
        return MyScaleVector(
            ...
            config=MyScaleConfig(
                host=magic_studio_config.MYSCALE_HOST,
                port=magic_studio_config.MYSCALE_PORT,
                user=magic_studio_config.MYSCALE_USER,
                password=magic_studio_config.MYSCALE_PASSWORD,
                database=magic_studio_config.MYSCALE_DATABASE,
                fts_params=magic_studio_config.MYSCALE_FTS_PARAMS,
            ),
        )
