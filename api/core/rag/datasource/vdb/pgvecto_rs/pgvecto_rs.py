    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVectoRS:
        ...
        return PGVectoRS(
            ...
            config=PgvectoRSConfig(
                host=magic_studio_config.PGVECTO_RS_HOST or "localhost",
                port=magic_studio_config.PGVECTO_RS_PORT or 5432,
                user=magic_studio_config.PGVECTO_RS_USER or "postgres",
                password=magic_studio_config.PGVECTO_RS_PASSWORD or "",
                database=magic_studio_config.PGVECTO_RS_DATABASE or "postgres",
            ),
            dim=dim,
        )
