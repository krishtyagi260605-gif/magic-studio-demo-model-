...
class MatrixoneVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MatrixoneVector:
        ...
        config = MatrixoneConfig(
            host=magic_studio_config.MATRIXONE_HOST or "localhost",
            port=magic_studio_config.MATRIXONE_PORT or 6001,
            user=magic_studio_config.MATRIXONE_USER or "dump",
            password=magic_studio_config.MATRIXONE_PASSWORD or "111",
            database=magic_studio_config.MATRIXONE_DATABASE or "dify",
            metric=magic_studio_config.MATRIXONE_METRIC or "l2",
        )
