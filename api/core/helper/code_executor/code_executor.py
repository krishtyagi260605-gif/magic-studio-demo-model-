...
code_execution_endpoint_url = URL(str(magic_studio_config.CODE_EXECUTION_ENDPOINT))
CODE_EXECUTION_SSL_VERIFY = magic_studio_config.CODE_EXECUTION_SSL_VERIFY
_CODE_EXECUTOR_CLIENT_LIMITS = httpx.Limits(
    max_connections=magic_studio_config.CODE_EXECUTION_POOL_MAX_CONNECTIONS,
    max_keepalive_connections=magic_studio_config.CODE_EXECUTION_POOL_MAX_KEEPALIVE_CONNECTIONS,
    keepalive_expiry=magic_studio_config.CODE_EXECUTION_POOL_KEEPALIVE_EXPIRY,
)
...
class CodeExecutor:
    ...
    def execute_code(cls, language: CodeLanguage, preload: str, code: str) -> str:
        ...
        headers = {"X-Api-Key": magic_studio_config.CODE_EXECUTION_API_KEY}
        ...
        timeout = httpx.Timeout(
            connect=magic_studio_config.CODE_EXECUTION_CONNECT_TIMEOUT,
            read=magic_studio_config.CODE_EXECUTION_READ_TIMEOUT,
            write=magic_studio_config.CODE_EXECUTION_WRITE_TIMEOUT,
            pool=None,
        )
