...
class PluginModelRuntime(ModelRuntime):
    ...
    def get_model_schema(
        ...
        *,
        ...
        if schema:
            try:
                redis_client.setex(cache_key, magic_studio_config.PLUGIN_MODEL_SCHEMA_CACHE_TTL, schema.model_dump_json())
            except (RedisError, RuntimeError) as exc:
                logger.warning(
    ...
    def get_llm_num_tokens(
        ...
        *,
        ...
        if not magic_studio_config.PLUGIN_BASED_TOKEN_COUNTING_ENABLED:
            return 0
