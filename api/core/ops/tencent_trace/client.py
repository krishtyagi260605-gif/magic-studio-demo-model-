    ...
    def __init__(
        ...
        self.resource = Resource(
            attributes={
                ...
                service_attributes.SERVICE_VERSION: f"dify-{magic_studio_config.project.version}-{magic_studio_config.COMMIT_SHA}",
                DEPLOYMENT_ENVIRONMENT: f"{magic_studio_config.DEPLOY_ENV}-{magic_studio_config.EDITION}",
        ...
        self.tracer = self.tracer_provider.get_tracer("dify-sdk", magic_studio_config.project.version)
        ...
        try:
            ...
            if metric_reader is not None:
                ...
                self.meter = provider.get_meter("dify-sdk", magic_studio_config.project.version)
