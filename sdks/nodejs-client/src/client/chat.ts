...
export class ChatClient extends MagicStudioClient {
  createChatMessage(
    request: ChatMessageRequest
  ): Promise<MagicStudioResponse<ChatMessageResponse> | MagicStudioStream<ChatMessageResponse>>;
  createChatMessage(
    inputs: JsonObject,
    query: string,
    user: string,
  ...
  getSuggested(
    messageId: string,
    user: string
  ): Promise<MagicStudioResponse<SuggestedQuestionsResponse>> {
  ...
  // Note: messageFeedback is inherited from MagicStudioClient

  getAppFeedbacks(
    page?: number,
    limit?: number
  ): Promise<MagicStudioResponse<JsonObject>> {
  ...
  ): Promise<MagicStudioResponse<AnnotationResponse>> {
  ...
  // Note: audioToText is inherited from MagicStudioClient
}
