...
import type { MagicStudioResponse, MagicStudioStream, QueryParams } from "../types/common";
import {
...
export class KnowledgeBaseClient extends MagicStudioClient {
  async listDatasets(
    options?: DatasetListOptions
  ): Promise<MagicStudioResponse<KnowledgeBaseResponse>> {
  ...
  async getDataset(datasetId: string): Promise<MagicStudioResponse<KnowledgeBaseResponse>> {
  ...
  async deleteDataset(datasetId: string): Promise<MagicStudioResponse<KnowledgeBaseResponse>> {
    ensureNonEmptyString(datasetId, "datasetId");
    return this.http.request({
      method: "DELETE",
      path: `/datasets/${datasetId}`,
  ...
  async listTags(): Promise<MagicStudioResponse<KnowledgeBaseResponse>> {
    return this.http.request({
      method: "GET",
      path: "/datasets/tags",
    });
  ...
  ): Promise<MagicStudioStream<PipelineStreamEvent>> {
    ensureNonEmptyString(datasetId, "datasetId");
  ...
  ): Promise<MagicStudioResponse<KnowledgeBaseResponse> | MagicStudioStream<PipelineStreamEvent>> {
    ensureNonEmptyString(datasetId, "datasetId");
    ensureNonEmptyString(request.datasource_type, "datasource_type");
