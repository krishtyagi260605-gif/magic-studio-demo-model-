...
export class WorkflowClient extends MagicStudioClient {
  run(
    request: WorkflowRunRequest
  ): Promise<MagicStudioResponse<WorkflowRunResponse> | MagicStudioStream<WorkflowRunResponse>>;
  run(
    inputs: JsonObject,
    user: string,
    stream?: boolean
  ...
  getRun(workflowRunId: string): Promise<MagicStudioResponse<WorkflowRunResponse>> {
