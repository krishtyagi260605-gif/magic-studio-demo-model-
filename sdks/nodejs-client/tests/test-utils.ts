...
import type { MagicStudioClientConfig, MagicStudioResponse } from "../src/types/common";
...
export const createHttpClient = (
  configOverrides: Partial<MagicStudioClientConfig> = {}
...
export const createHttpClientWithSpies = (
  ...
  const request = vi
    ...
    .mockResolvedValue({ data: "ok", status: 200, headers: {} } as MagicStudioResponse<string>);
