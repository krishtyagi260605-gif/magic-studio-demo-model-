# MagicStudio Node.js SDK

This is the Node.js SDK for the MagicStudio API, which allows you to easily integrate MagicStudio into your Node.js applications.

## Install

```bash
npm install magicstudio-client
```
...
const client = new MagicStudioClient(API_KEY)
