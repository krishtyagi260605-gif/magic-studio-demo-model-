...
class MagicStudioClient {
    ...
    public function __construct($api_key, $base_url = null) {
        ...
        $this->base_url = $base_url ?? 'https://api.magicstudio.ai/v1/';
...
class CompletionClient extends MagicStudioClient {
...
class ChatClient extends MagicStudioClient {
...
class WorkflowClient extends MagicStudioClient{
