  ...
  return (
    <>
      <div className={cn('relative flex min-h-screen w-full justify-center overflow-hidden bg-[#050914] p-6')}>
        ...
        <div className={cn('relative flex w-full shrink-0 flex-col items-center rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(10,16,30,0.94),rgba(6,10,20,0.88))] shadow-[0_30px_120px_rgba(0,0,0,0.45)] backdrop-blur-2xl')}>
          <Header />
          <div className={cn('flex w-full grow flex-col items-center justify-center px-6 md:px-[108px]')}>
            <div className="flex flex-col md:w-[430px]">
              {children}
            </div>
          </div>
