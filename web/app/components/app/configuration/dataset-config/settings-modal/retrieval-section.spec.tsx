...
describe('RetrievalSection', () => {
  ...
  it('renders internal retrieval config with doc link', () => {
    ...
    expect(learnMoreLink).toHaveAttribute('href', 'https://docs.example/magic-studio/knowledge/create-knowledge/setting-indexing-methods')
    expect(docLink).toHaveBeenCalledWith('/magic-studio/knowledge/create-knowledge/setting-indexing-methods')
  })
