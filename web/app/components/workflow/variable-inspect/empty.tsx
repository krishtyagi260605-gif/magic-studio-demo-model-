...
const Empty: FC = () => {
  ...
  return (
    <div className="flex h-full flex-col gap-3 rounded-xl bg-background-section p-8">
      <div className="flex h-10 w-10 items-center justify-center radius-lg border-[0.5px] border-components-card-border bg-components-card-bg shadow-lg backdrop-blur-xs">
      ...
      <div className="flex flex-col gap-1">
        ...
        <a
          ...
          href={docLink('/magic-studio/debug/variable-inspect')}
          target="_blank"
