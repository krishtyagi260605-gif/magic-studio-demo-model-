...
describe('Status', () => {
  ...
  it('renders the exception learn-more link', () => {
    ...
    expect(learnMoreLink).toHaveAttribute('href', resolveDocLink('/magic-studio/debug/error-type'))
    expect(mockDocLink).toHaveBeenCalledWith('/magic-studio/debug/error-type')
  })
