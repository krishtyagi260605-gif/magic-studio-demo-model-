...
const FailBranchCard = () => {
  ...
  return (
    <div className="px-4 pt-2">
      <div className="radius-lg bg-workflow-process-bg p-4">
        <div className="mb-2 flex h-8 w-8 items-center justify-center radius-lg border-[0.5px] border-components-card-border bg-components-card-bg shadow-lg">
