...
<p align="center">
  📌 <a href="https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio">Predstavljamo nalaganje datotek Magic Studio Workflow: znova ustvarite Google NotebookLM Podcast</a>
</p>

<p align="center">
  <a href="https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio">Magic Studio Cloud</a> ·
  <a href="https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio">Samostojno gostovanje</a> ·
  <a href="https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio">Dokumentacija</a> ·
  <a href="https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio">Pregled ponudb izdelkov Magic Studio</a>
</p>
...
Magic Studio je odprtokodna platforma za razvoj aplikacij LLM. Njegov intuitivni vmesnik združuje agentski potek dela z umetno inteligenco, cevovod RAG, zmogljivosti agentov, upravljanje modelov, funkcije opazovanja in več, kar vam omogoča hiter prehod od prototipa do proizvodnje.

## Hitri začetek

> Preden namestite Magic Studio, se prepričajte, da vaša naprava izpolnjuje naslednje minimalne sistemske zahteve:
>
> - CPU >= 2 Core
> - RAM >= 4 GiB
...
Najlažji način za zagon strežnika Magic Studio je prek docker compose . Preden zaženete Magic Studio z naslednjimi ukazi, se prepričajte, da sta Docker in Docker Compose nameščena na vašem računalniku:
...
Po zagonu lahko dostopate do nadzorne plošče Magic Studio v brskalniku na [http://localhost/install](http://localhost/install) in začnete postopek inicializacije.

#### Iskanje pomoči

Prosimo, glejte naša pogosta vprašanja [FAQ](https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio) če naletite na težave pri nastavitvi Magic Studio. Če imate še vedno težave, se obrnite na [skupnost ali nas](#community--contact).

> Če želite prispevati k Difyju ali narediti dodaten razvoj, glejte naš vodnik za [uvajanje iz izvorne kode](https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio)
...
Brezhibna integracija s stotinami lastniških/odprtokodnih LLM-jev ducatov ponudnikov sklepanja in samostojnih rešitev, ki pokrivajo GPT, Mistral, Llama3 in vse modele, združljive z API-jem OpenAI. Celoten seznam podprtih ponudnikov modelov najdete [tukaj](https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio).
...
definirate lahko agente, ki temeljijo na klicanju funkcij LLM ali ReAct, in dodate vnaprej izdelana orodja ali orodja po meri za agenta. Magic Studio ponuja več kot 50 vgrajenih orodij za agente AI, kot so Google Search, DALL·E, Stable Diffusion in WolframAlpha.
...
AVse ponudbe Difyja so opremljene z ustreznimi API-ji, tako da lahko Magic Studio brez težav integrirate v svojo poslovno logiko.

## Uporaba Magic Studio

- **Cloud </br>**
  Gostimo storitev Magic Studio Cloud za vsakogar, ki jo lahko preizkusite brez nastavitev. Zagotavlja vse zmožnosti različice za samostojno namestitev in vključuje 200 brezplačnih klicev GPT-4 v načrtu peskovnika.

- **Self-hosting Magic Studio Community Edition</br>**
  Hitro zaženite Magic Studio v svojem okolju s tem [začetnim vodnikom](#quick-start) . Za dodatne reference in podrobnejša navodila uporabite našo [dokumentacijo](https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio) .

- **Magic Studio za podjetja/organizacije</br>**
  ...
  > Za novoustanovljena podjetja in mala podjetja, ki uporabljajo AWS, si oglejte Magic Studio Premium na AWS Marketplace in ga z enim klikom uvedite v svoj AWS VPC. To je cenovno ugodna ponudba AMI z možnostjo ustvarjanja aplikacij z logotipom in blagovno znamko po meri.
...
- [Nadzorna plošča Grafana avtorja @bowenliang123](https://github.com/bowenliang123/magic-studio-grafana-dashboard)
...
namestite Magic Studio v Cloud Platform z enim klikom z uporabo [terraform](https://www.terraform.io/)
...
Uvedite Magic Studio v AWS z uporabo [CDK](https://aws.amazon.com/cdk/)
...
Z enim klikom namestite Magic Studio na Alibaba Cloud z [Alibaba Cloud Data Management](https://www.alibabacloud.com/help/en/dms/magic-studio-in-invitational-preview/)

#### Uporaba Azure Devops Pipeline za uvajanje v AKS

Z enim klikom namestite Magic Studio v AKS z uporabo [Azure Devops Pipeline Helm Chart by @LeoZhang](https://github.com/Ruiruiz30/Magic Studio-helm-chart-AKS)

## Prispevam

Za tiste, ki bi radi prispevali kodo, si oglejte naš [vodnik za prispevke](https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio/blob/main/CONTRIBUTING.md). Hkrati vas prosimo, da podprete Magic Studio tako, da ga delite na družbenih medijih ter na dogodkih in konferencah.
...
- [GitHub Discussion](https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio). Najboljše za: izmenjavo povratnih informacij in postavljanje vprašanj.
- [GitHub Issues](https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio/issues). Najboljše za: hrošče, na katere naletite pri uporabi Magic Studio.AI, in predloge funkcij. Oglejte si naš [vodnik za prispevke](https://github.com/krishtyagi260605-gif/magic-studio-demo-model-magic-studio/blob/main/CONTRIBUTING.md).
- [Discord](mailto:hello@magicstudio.dev). Najboljše za: deljenje vaših aplikacij in druženje s skupnostjo.
...
Zaradi zaščite vaše zasebnosti se izogibajte objavljanju varnostnih vprašanj na GitHub. Namesto tega pošljite vprašanja na hello@magicstudio.dev in zagotovili vam bomo podrobnejši odgovor.

## Licenca

To skladišče je na voljo pod [odprtokodno licenco Magic Studio](../../LICENSE) , ki je v bistvu Apache 2.0 z nekaj dodatnimi omejitvami.
